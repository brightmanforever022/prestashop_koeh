...
// We suppose Cookie is not needed
...
/*file_put_contents(_PS_ROOT_DIR_.'/webservice/xml.log', date('Y-m-d H:i:s').' '.$method.' '. $_GET['url'].' '.
    ($method=='GET'?print_r($params, true).' ':'').$input_xml."\n", FILE_APPEND);*/
