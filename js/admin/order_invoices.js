...
// change document paid state link
    ...
    $('.sumToPay').on('dblclick', function(e){
        ...
        $("#cst_cntr_name").multipleSelect({
            multiple: true,
            multipleWidth: 200,
            container: '#countriesSelectContainer',
            onOpen: function(){
            	$('#countriesSelectContainer .ms-drop').width('220px');
            }

        });
        $("#reminder_state").multipleSelect({
            multiple: true,
            multipleWidth: 200,
            container: '#remindersSelectContainer',
            onOpen: function(){
            	$('#remindersSelectContainer .ms-drop').width('220px');
            }
        });
        $('select[name="order_invoiceFilter_payment_type[]"]').multipleSelect({
            multiple: true,
            multipleWidth: 200,
            dropWidth: 450
        });
