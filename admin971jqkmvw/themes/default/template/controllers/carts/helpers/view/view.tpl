						...
						<tr>
							...
							<td>
								<a href="{$link->getAdminLink('AdminProducts')|escape:'html':'UTF-8'}&amp;id_product={$product.id_product}&amp;updateproduct">
									...
									{if isset($product.attributes)}<br />{$product.attributes}{/if}<br />
									{if $product.reference}{l s='Ref:'} {$product.reference}<br>{/if}
									{if $product.supplier_reference}{l s='Supplier ref.:'} {$product.supplier_reference}{/if}
								</a>
							</td>
