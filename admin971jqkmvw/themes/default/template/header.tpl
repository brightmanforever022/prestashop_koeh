...
{/if}
		...
		var customerCreditLimitController = '{$link->getAdminLink("AdminCustomerCreditLimitHistory")|addslashes}';
		var customerCreditLimitExceededMessage = "{l s='Customer has reached his credit limit of @limit €. Are you sure to create this invoice?' js=1}";
	</script>
{/if}
{if isset($css_files)}
