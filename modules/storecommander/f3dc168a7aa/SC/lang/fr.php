<?php $LANG =array (
  ...
  'Product with no cover image' => 'Produit avec aucune image principale',
  ...
  'Multiple choices or write value' => 'Choix multiples ou valeur personnalisé',
  ...
  'Start date (format: 2016-05-15):' => 'Date de début (format: 2016-05-15) :',
  'End date (format: 2016-05-15):' => 'Date de fin (format: 2016-05-15) :',
  ...
  'Tickets: Open tickets from employee X' => 'Tickets ouverts de l\'employé X',
  ...
  'Associated' => 'Associé',
  'Place selected order in selected segments' => 'Ajouter la commande sélectionnée dans les segments sélectionnés',
  'Remove selected order from selected segments' => 'Retirer la commande sélectionnée des segments sélectionnés',
  'Place selected customer in selected segments' => 'Ajouter le client sélectionné dans les segments sélectionnés',
  'Remove selected customer from selected segments' => 'Retirer le client sélectionné des segments sélectionnés',
  'Place selected product in selected segments' => 'Ajouter le produit sélectionné dans les segments sélectionnés',
  'Remove selected product from selected segments' => 'Retirer le produit sélectionné des segments sélectionnés',
  'Display only segments used by selected product' => 'Afficher uniquement les segments associés au produit sélectionné',
  'Display only segments used by selected order' => 'Afficher uniquement les segments associés à la commande sélectionné',
  'Display only segments used by selected customer' => 'Afficher uniquement les segments associés au client sélectionné',
  'Open segment' => 'Ouvrir le segment',
  'Modify quantity, possible values: +5, -5, 5.25,...' => 'Modifier le stock, valeurs possibles : +5, -5, 5.25,...',
  'Orders grid: Language to apply to display the product names' => 'Grille commandes : Langue à utiliser pour afficher le nom du produit',
  'Possible values:<br/>1: PS Employee language<br/>2: Selected shop language<br/>FR,EN,DE,... : Specific language' => 'Valeurs possibles :<br/>1: Langue de l\'employé PS<br/>2: Langue de la boutique sélectionnée<br/>FR,EN,DE,... : Langue spécifique',
  'Modify' => 'Modifier',
  'SC Solo to SC Multistores' => 'SC Solo vers SC Multiboutiques',
  '12 months updates and support for your SC  Solo' => '12 mois de mises à jour et support pour votre SC Solo',
  '12 months updates and support for your SC Multistores' => '12 mois de mises à jour et support pour votre SC Multiboutiques',
  'Read the Terms & Conditions' => 'Lire les Conditions Générales de Vente',
  'Show available e-Services only for your shop' => 'Afficher uniquement les e-Services disponibles pour votre boutique',
  '12 months support and updates' => '12 mois de support & mises à jour',
  'PM Multiple features' => 'PM Caractéristiques Multiples',
  'Grid Editor' => 'Editeur de Grilles',
  'Grid Editor Pro' => 'Editeur de Grilles Pro',
  'Add a new field in SC with Grid Editor Pro' => 'Ajouter un nouveau champ à SC avec Editeur de Grilles Pro',
  'Low stock alert' => 'Alerte quantité basse',
  'Low stock threshold' => 'Seuil quantité basse',
  'Additional delivery times' => 'Temps de livraison supplémentaire',
  ...
  'Ukoo Product Compatibilities' => 'Ukoo Compatibilités Produits',
  'Associate parts to the right product in bulk' => 'Associez en masse les pièces détachées au bon produit',
  'Segment customers/orders/products for a targetted process' => 'Segmentez les clients/commandes/produits pour un traitement ciblé',
  'Customize SC grids' => 'Personnalisez les grilles de SC',
  'Customize SC grids with information related to your activity' => 'Personnalisez les grilles de SC avec des informations de votre activité',
  'Always save on productivity with Store Commander' => 'Gagner toujours plus de productivité avec Store Commander',
  'Add multiple features on a product' => 'Renseignez plusieurs caractéristiques/composants pour un produit',
  'Easily identify and fix technical issues on your store' => 'Identifiez et réparez facilement les problèmes techniques de votre boutique',
  'Initiation Training for Store Commander Solo' => 'Formation Initiation pour Store Commander Solo',
  'Initiation Training for Store Commander Multistore' => 'Formation Initiation pour Store Commander Multiboutiques',
  'CSV Import Training' => 'Formation Store Commander Import CSV',
  'CSV Export Training' => 'Formation Store Commander Export CSV',
  'Feed.Biz product options' => 'Feed.Biz options produit',
  'Feed.Biz Amazon options' => 'Feed.Biz options Amazon',
  'ID product' => 'ID produit',
  'ID product attribute' => 'ID attribut',
  ...
  'Don\'t synchronize price' => 'Synchronization des prix',
  'Don\'t synchronize quantity' => 'Synchronization des quantités',
  'Shipped by Amazon (FBA)' => 'Expédié par Amazon (FBA)',
  'Latency' => 'Délai',
  'Bullet point 1' => 'Caractéristique clé 1',
  'Bullet point 2' => 'Caractéristique clé 2',
  'Bullet point 3' => 'Caractéristique clé 3',
  'Bullet point 4' => 'Caractéristique clé 4',
  'Bullet point 5' => 'Caractéristique clé 5',
  'Shipping type' => 'Type d\'expédition',
  'Gift wrap' => 'Emballage cadeau',
  'Browse node' => 'Noeud d\'arborescence',
  'Expedition template' => 'Template d\'expédition',
  'Product option exist' => 'Option produit existante',
  'Product attribute option exist' => 'Options d\'attribut produit existantes',
  'Product Amazon option exist' => 'Option produit Amazon existante',
  'Product attribute Amazon option exist' => 'Options d\'attribut produit Amazon existantes',
  'PDF Catalog Module' => 'Module Catalogue PDF',
  'Create your PDF catalog for your customers, prints,..' => 'Créez des catalogues PDF pour vos clients, à imprimer...',
  'Addon' => 'Extension',
  'e-Services list' => 'Liste des e-Services',
  'Your projects' => 'Vos projets',
  'Order margin' => 'Marge de la commande',
  'Show accessory product image' => 'Afficher l\'image des accessoires produit',
  'Your API key to use tinyPNG' => 'Votre clé API pour utiliser tinyPNG',
  'If you want to use TinyPNG in Store Commander, you must have an API key.' => 'Si vous voulez utilisez TinyPNG dans Store Commande, vous devez avoir une clé API.',
  'Compress images loaded in SC to speed up the display on your site' => 'Compressez les images chargées dans SC pour accélérer l\'affichage de votre site',
  'Customer Export Module' => 'Module Export Clients',
  'Post your offers on paper or PDF format' => 'Publiez vos offres sur support PDF ou papier',
  'Target and optimize marketing actions' => 'Ciblez et optimisez vos actions marketing',
  'Prepare data for your accountant quickly' => 'Préparez rapidement les données pour votre comptable',
  'You must select only one image' => 'Vous ne devez sélectionnez qu\'une seule image',
  'You must select one image' => 'Vous devez sélectionnez une seule image',
  ...
  'No image founded' => 'Pas d\'image trouvée',
  'No image sended' => 'Aucune image envoyée',
  'You don\'t have enough Fizz in your wallet for this action. Please buy Fizz in e-Services menu.' => 'Vous n\'avez pas assez de Fizz dans votre porte-monnaie pour effectuer cette action. Veuillez en ajouter par le menu e-Services.',
  'An error occured. Please contact our support.' => 'Une erreur s\'est produite. Veuillez contacter notre support.',
  'Permanent' => 'Permanent',
  'Cut out' => 'Détourage',
  'My images to cut out' => 'Mes images à détourer',
  'Images added in project.' => 'Les images ont été ajoutées au projet.',
  'Add images in this project to cut out them later' => 'Ajouter des images à ce projet pour les détourer plus tard',
  'Amount (Fizz)' => 'Montant (Fizz)',
  'Items list' => 'Liste des éléments',
  'Remove selected items' => 'Supprimer les éléments sélectionnés',
  'Managing your projects' => 'Gérer vos projets',
  'Select a project to configure it.' => 'Sélectionner un projet pour le configurer.',
  'Customer Export Pro Module' => 'Module Export Client Pro',
  'Order Export Pro Module' => 'Module Export Commande Pro',
  'Cut out images' => 'Détourage d\'images',
  'Number of images you can cut out:' => 'Nombre d\'images que vous pouvez détourer :',
  'You can cut out 10 000 images with so many fizz' => 'Vous pouvez détourer 10 000 images avec autant de fizz',
  'You can cut out 2 500 images with so many fizz' => 'Vous pouvez détourer 2 500 images avec autant de fizz',
  'You can cut out 500 images with so many fizz' => 'Vous pouvez détourer 500 images avec autant de fizz',
  'You can cut out 50 images with so many fizz' => 'Vous pouvez détourer 50 images avec autant de fizz',
  'Pack of 2000 Fizz' => 'Lot de 2000 Fizz',
  'Pack of 10 Fizz' => 'Lot de 10 Fizz',
  'Pack of 100 Fizz' => 'Lot de 100 Fizz',
  'Pack of 500 Fizz' => 'Lot de 500 Fizz',
  'Refresh cart' => 'Recalculer le panier',
  'Partner' => 'Partenaire',
  'Firtname' => 'Prénom',
  ...
  'Custom links in tools menu' => 'Liens personnalisés dans le menu Outils',
  ...
  'product reference - unique id' => 'Référence produit - ID auto',
  'product reference - id_product_attribute' => 'Référence produit - ID déclinaison',
  'Combination references' => 'Références déclinaisons',
  'product reference - unique id - name' => 'Référence produit - ID auto - attributs',
  ...
  'We are checking the status of the project and importing data.' => 'Vérirication en cours du statut du projet et import des données.',
  'elements' => 'éléments',
  'element' => 'élément',
  ...
  'product sharing same reference' => 'produits partageant la même référence',
  'List of id_product with same reference' => 'Liste des id_product partageant la même référence',
  'Products same ref.' => 'Pdts même réf.',
  'product sharing same UPC' => 'produits partageant le même UPC',
  'List of id_product with same UPC' => 'Liste des id_product partageant le même UPC',
  'Products same UPC' => 'Pdts même UPC',
  'product sharing same EAN13' => 'produits partageant le même EAN13',
  'List of id_product with same EAN13' => 'Liste des id_product partageant le même EAN13',
  'Products same EAN13' => 'Pdts même EAN13',
  'combination sharing same reference' => 'déclinaisons partageant la même référence',
  'List of id_product_attribute with same reference' => 'Liste des id_product_attribute qui partagent la même référence',
  'Combi. same ref.' => 'Décli. même ref.',
  'combination sharing same EAN13' => 'déclinaisons partageant le même EAN13',
  'List of id_product_attribute with same EAN13' => 'Liste des id_product_attribute qui partagent le même EAN13',
  'Combi. same EAN13' => 'Décli. même EAN13',
  'combination sharing same UPC' => 'déclinaisons partageant le même UPC',
  'List of id_product_attribute with same UPC' => 'Liste des id_product_attribute qui partagent le même UPC',
  ...
  'List of product/combination with same EAN13' => 'Liste des produits/déclinaisons avec le même EAN13',
  'product sharing same EAN13 with combination' => 'produits partageant le même EAN13 avec des déclinaisons',
  'product sharing same reference with combination' => 'produits partageant la même Référence avec des déclinaisons',
  'List of product/combination with same reference' => 'Liste des produits/déclinaisons avec la même Référence',
  'product sharing same UPC with combination' => 'produits partageant le même UPC avec des déclinaisons',
  'List of product/combination with same upc' => 'Liste des produits/déclinaisons avec le même UPC',
  ...
  'Go to the combination in catalog.' => 'Accéder à la déclinaison dans le catalogue.',
  ...
  'Go to the order' => 'Accéder à la commande',
