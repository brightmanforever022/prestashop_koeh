 ...
 **/
	...
	function getPages($id_cms_category = null)
	{
        ...
        if (SCMS && SCI::getSelectedShop()>0)
        {
            ...
            $sql .= " INNER JOIN "._DB_PREFIX_."cms_lang cl ON (c.id_cms = cl.id_cms AND cl.id_lang = '".(int)$id_lang."' AND cl.id_shop = '".(int)SCI::getSelectedShop()."') ";
        }
        else
		...
		foreach($res as $cmsRow){
            ...
            sc_ext::readCustomCMSGridsConfigXML('rowUserData',$gridrow);
