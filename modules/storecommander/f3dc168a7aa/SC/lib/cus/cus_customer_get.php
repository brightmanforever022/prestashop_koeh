 ...
 **/
	...
	{
		global $sql,$id_segment,$groupFilter,$filter_params,$group,$sc_agent,$arrGroupes,$language_arr,$id_lang,$cols,$view,$colSettings,$user_lang_iso,$fields_order,$fields_customer,$fields_lang,$col,$gridrow;
		...
		if ($view=='grid_address' || sc_in_array("id_address", $cols,"cusGet_cols"))
		{
			...
			$sql = "SELECT a.id_address,".psql($sqlAddress).(version_compare(_PS_VERSION_, '1.5.0.0', '<') ? ",0 as id_shop" : ",c.id_shop");
