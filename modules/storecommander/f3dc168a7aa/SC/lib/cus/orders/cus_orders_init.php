...
?>
	...
	prop_tb.addButton("customerorder_gobo", 100, "", "lib/img/cart_ps.png", "lib/img/cart_ps.png");
	prop_tb.setItemToolTip('customerorder_gobo','<?php echo _l('View selected orders in Prestashop',1)?>');
    prop_tb.addButton("customerorder_selectall", 100, "", "lib/img/application_lightning.png", "lib/img/application_lightning_dis.png");
    prop_tb.setItemToolTip('customerorder_selectall','<?php echo _l('Select all',1)?>');
    prop_tb.addButton("customerorder_exportcsv", 100, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
	...
	function initCustomerOrder(){
		if (needinitCustomerOrder)
		{
            ...
            prop_tb._customerProductGrid_TB.addButton("customerordersProducts_refresh", 100, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
            prop_tb._customerProductGrid_TB.setItemToolTip('customerordersProducts_refresh','<?php echo _l('Refresh grid',1)?>');
            prop_tb._customerProductGrid_TB.addButton("customerordersProducts_exportcsv", 100, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
            ...
            prop_tb._customerProductGrid_TB.addButton("gotocatalog", 101, "", "lib/img/table_go.png", "lib/img/table_go.png");
