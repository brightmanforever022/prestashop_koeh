...
$permissions_list = array(
	...
	, 'ACT_CAT_CONTEXTMENU_COPY_PASTE' => array('id'=>'ACT_CAT_CONTEXTMENU_COPY_PASTE','section1'=>'Action','section2'=>'Catalog','name'=>'Contextual menu : copy/paste','description'=>'', 'default_admin'=>1, 'default_value'=>1)
	...
	, 'GRI_CUS_PROPERTIES_GRID_NOTES' => array('id'=>'GRI_CUS_PROPERTIES_GRID_NOTES','section1'=>'Grid','section2'=>'Customers','name'=>'Properties grid: Notes','description'=>'', 'default_admin'=>1, 'default_value'=>1)
    ...
    , 'MEN_TRENDS' => array('id'=>'MEN_TRENDS','section1'=>'Menu','section2'=>'Trends','name'=>'Trends','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'MEN_CAT_TOOLS' => array('id'=>'MEN_CAT_TOOLS','section1'=>'Menu','section2'=>'Catalog','name'=>'Tools','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'MEN_CAT_TOOLS_REBUILD_PRODUCT_PRICE' => array('id'=>'MEN_CAT_TOOLS_REBUILD_PRODUCT_PRICE','section1'=>'Menu','section2'=>'Catalog','name'=>'Set product prices to their default combination prices','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'GRI_CAT_PROPERTIES_GRID_SUPPLIER' => array('id'=>'GRI_CAT_PROPERTIES_GRID_SUPPLIER','section1'=>'Grid','section2'=>'Catalog','name'=>'Properties grid: supplier','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'GRI_CAT_PROPERTIES_GRID_SEO' => array('id'=>'GRI_CAT_PROPERTIES_GRID_SEO','section1'=>'Grid','section2'=>'Catalog','name'=>'Properties grid: SEO','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'MEN_CAT_SPECIFIC_PRICE' => array('id'=>'MEN_CAT_SPECIFIC_PRICE','section1'=>'Menu','section2'=>'Catalog','name'=>'Specific prices','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'MEN_TOO_CUSTOM_LINKS' => array('id'=>'MEN_TOO_CUSTOM_LINKS','section1'=>'Menu','section2'=>'Tools','name'=>'Custom links in tools menu','description'=>'', 'default_admin'=>1, 'default_value'=>1)

    , 'MEN_E_SERVICES_LINKS' => array('id'=>'MEN_E_SERVICES_LINKS','section1'=>'Menu','section2'=>'E-services','name'=>'E-Services in menu','description'=>'', 'default_admin'=>1, 'default_value'=>1)
