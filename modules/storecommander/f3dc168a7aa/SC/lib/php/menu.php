...
<?php
	...
	if (version_compare(_PS_VERSION_, '1.4.0.0', '>=') && _r("MEN_CAT_SPECIFIC_PRICE"))
	{
	?>
...
if (version_compare(_PS_VERSION_, '1.2.0.0', '>='))
    ...
    {
        ?>
        '<item id="acc_quickaccounting" text="<?php echo _l('CSV Export',1)?> (Quick Compta)" img="lib/img/database_go.png" imgdis="lib/img/database_go.png"></item>'+
        <?php
    }else{
        ?>
        '<item id="teaser_quickaccounting" text="<?php echo _l('CSV Export',1)?> (Quick Compta)" img="lib/img/calculator_edit.png" imgdis="lib/img/calculator_edit.png">'+
...
{	?>
    '<item id="affiliation" text="<?php echo _l('Affiliation program',1)?>" img="lib/img/group_link.png" imgdis="lib/img/group_link.png"/>'+
<?php }else{
?>
...
?>
        '<item id="catalog_pdf" text="<?php echo _l('Create your PDF Catalog',1)?>" img="lib/img/page_pdf.png" imgdis="lib/img/page_pdf.png">'+
            '<item id="catalog_pdf_read" text="<?php echo _l('Read more',1)?>" img="lib/img/tick.png" imgdis="lib/img/tick.png"/>'+
        '</item>'+
        '<item id="sc_amazon" text="<?php echo _l('Check SC Amazon for Amazon module',1)?>" img="lib/img/amazon.png" imgdis="lib/img/amazon.png">'+
            '<item id="sc_amazon_read" text="<?php echo _l('Read more',1)?>" img="lib/img/tick.png" imgdis="lib/img/tick.png"/>'+
        '</item>'+
        '<item id="sc_cdiscount" text="<?php echo _l('Check SC Cdiscount for Cdiscount module',1)?>" img="lib/img/cdiscount.png" imgdis="lib/img/cdiscount.png">'+
            '<item id="sc_cdiscount_read" text="<?php echo _l('Read more',1)?>" img="lib/img/tick.png" imgdis="lib/img/tick.png"/>'+
        '</item>'+
        '<item id="sc_feedbiz" text="<?php echo _l('Check SC Feed.biz for Feed.biz Amazon/Cdiscount',1)?>" img="lib/img/feedbiz.png" imgdis="lib/img/feedbiz.png">'+
            '<item id="sc_feedbiz_read" text="<?php echo _l('Read more',1)?>" img="lib/img/tick.png" imgdis="lib/img/tick.png"/>'+
        '</item>'+
'</item>'+
<?php } ?>
...
?>
	...
	if(_r("MEN_TOO_GRIDSSETTINGS")) {
		...
		{	?>
	'<item id="teaser_gridseditor" text="<?php echo _l('Interface customization',1)?>" img="lib/img/table_gear.png" imgdis="lib/img/table_gear.png">'+
		'<item id="teaser_gridseditor_read" text="<?php echo _l('Read more',1)?>" img="lib/img/tick.png" imgdis="lib/img/tick.png"></item>'+
	'</item>'+
	<?php }else{ ?>
	'<item id="win_grids_editor" text="<?php echo _l('Interface customization',1)?>" img="lib/img/table_gear.png" imgdis="lib/img/table_gear.png"/>'+
	<?php }
		} 
		if(_r("MEN_MAR_SEGMENTATION"))
        {
...
<?php
	...
	{
?>
      '<item id="fixmyprestashop" text="FixMyPrestashop" img="lib/img/tick.png" imgdis="lib/img/tick.png"/>'+
<?php
	} else {
?>
        ...
        '</item>'+
    <?php }
    if (SC_Terminator_ACTIVE && SCI::moduleIsInstalled("scterminator"))
    {	?>
    '<item id="terminator" text="<?php echo _l('Database cleaning and optimization')?>" img="lib/img/database_refresh.png" imgdis="lib/img/database_refresh.png"/>'+
<?php }?>
'</item>'+
<?php } ?>
...
'<item id="trends" text="<?php echo _l('Trends',1)?>" img="lib/img/chart_bar.png" imgdis="lib/img/chart_bar.png">'+
    ...
    '<item id="trends_shop" text="<?php echo _l('Your shop trends',1)?>" img="lib/img/chart_curve.png" imgdis="lib/img/chart_curve.png"/>'+
'</item>'+
<?php }
if(KAI9DF4!=1 && _r("MEN_E_SERVICES_LINKS")) { ?>
'<item id="eservices_group" text="<?php echo _l('e-Services',1)?>" img="lib/img/ruby.png" imgdis="lib/img/ruby.png">'+
    '<item id="eservices" text="<?php echo _l('e-Services list',1)?>" img="lib/img/ruby.png" imgdis="lib/img/ruby.png"/>'+
    '<item id="eservices_project" text="<?php echo _l('Your projects',1)?>" img="lib/img/bricks.png" imgdis="lib/img/bricks.png"/>'+
'</item>'+
<?php } ?>
...
'<item id="link" text="<?php echo _l('Links',1)?>" img="lib/img/lightning.png" imgdis="lib/img/lightning.png">'+
    ...
    <?php if(_r("MEN_TOO_CUSTOM_LINKS")) { ?>
        ...
        if(!empty($link) && strpos($link,";")!==false) {
            ...
            $has_link = true;
            ?>
            '<item id="tools_links_1" text="<?php echo (!empty($name)?$name:$url); ?>" img="lib/img/building_go.png" imgdis="lib/img/building_go.png"></item>'+
        <?php }
        ...
        if(!empty($link) && strpos($link,";")!==false) {
            ...
            $has_link = true
            ?>
            '<item id="tools_links_2" text="<?php echo (!empty($name)?$name:$url); ?>" img="lib/img/building_go.png" imgdis="lib/img/building_go.png"></item>'+
        <?php }
        ...
        if(!empty($link) && strpos($link,";")!==false) {
            ...
            $has_link = true
            ?>
            '<item id="tools_links_3" text="<?php echo (!empty($name)?$name:$url); ?>" img="lib/img/building_go.png" imgdis="lib/img/building_go.png"></item>'+
        <?php }
        ...
        if(!empty($link) && strpos($link,";")!==false) {
            ...
            $has_link = true
            ?>
            '<item id="tools_links_4" text="<?php echo (!empty($name)?$name:$url); ?>" img="lib/img/building_go.png" imgdis="lib/img/building_go.png"></item>'+
        <?php }
        ...
        if(!empty($link) && strpos($link,";")!==false) {
            ...
            $has_link = true
            ?>
            '<item id="tools_links_5" text="<?php echo (!empty($name)?$name:$url); ?>" img="lib/img/building_go.png" imgdis="lib/img/building_go.png"></item>'+
        <?php } ?>
        '<item id="tools_links_manage" text="<?php echo _l("Manage custom links"); ?>" img="lib/img/building_edit.png" imgdis="lib/img/building_edit.png"></item>'+
    <?php } ?>
'</item>'+
<?php } ?>
