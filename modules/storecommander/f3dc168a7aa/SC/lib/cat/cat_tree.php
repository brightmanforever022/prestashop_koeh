...
<?php
    ...
    cat_tb.addButtonTwoState("hide_disable_cat", 0, "", "lib/img/filter.png", "lib/img/filter.png");
...
?>
	...
	cat_tree.setImagesPath('lib/js/imgs/');
	...
	function displayTree(callback)
	{
		...
		if(enalbeDynamicTreeLoading){
		    ...
		    cat_tree.load(url_dynamic_load,function(){
                ...
                {
                    if (catselection) {
                        let path_to_open = catselection_path.join(',');
                        cat_tree.openItemsDynamic(path_to_open,true);
