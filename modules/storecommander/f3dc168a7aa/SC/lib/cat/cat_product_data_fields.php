...
$format = (_s('CAT_PROD_PRICEWITHOUTTAX4DEC') ? '0.0000' : '0.00');
$colSettings['price']=array('text' => _l('Price excl. Tax'),'width'=>65,'align'=>'right','type'=>'edn','sort'=>'int','color'=>'','filter'=>'#numeric_filter','format'=>$format);
...
if(version_compare(_PS_VERSION_, '1.7.3.0', '>=')) {
    ...
    $colSettings['low_stock_threshold']=array('text' => _l('Low stock threshold'),'width'=>60,'align'=>'left','type'=>'edn','sort'=>'int','color'=>'','filter'=>'#numeric_filter','options'=>array(0=>_l('No'),1=>_l('Yes')));
}
...
if(defined('SC_FeedBiz_ACTIVE') && SC_FeedBiz_ACTIVE == 1 && SCI::moduleIsInstalled('feedbiz')) {
    ...
    if($market_place_allowed['amazon']) {
        ...
        $colSettings['fpao_gift_wrap']=array('text' => _l('Grif wrap'),'width'=>60,'align'=>'center','type'=>'coro','sort'=>'int','color'=>'','filter'=>'#select_filter','options'=>array(0=>_l('No'),1=>_l('Yes')));
        $colSettings['fpao_gift_message']=array('text' => _l('Grif wrap'),'width'=>60,'align'=>'center','type'=>'coro','sort'=>'int','color'=>'','filter'=>'#select_filter','options'=>array(0=>_l('No'),1=>_l('Yes')));
