...
?>
    ...
    <?php if(KAI9DF4!=1) { ?>
    var opts = [
    ['image_eservices_cutout', 'obj', '<?php echo _l('Cut the selected image out',1)?>', 'lib/img/eservices_cp.png'],
    ['image_eservices_cutout_addproject', 'obj', '<?php echo _l('Add selected images in projet to cut them out',1)?>', 'lib/img/eservices_cp.png'],
    ['image_eservices_cutout_seeproject', 'obj', '<?php echo _l('See cut out project',1)?>', 'lib/img/eservices_cp.png']
    ];
    prop_tb.addButtonSelect("image_eservices_list", 100, "",opts, "lib/img/ruby.png", "lib/img/ruby.png",false,true);
