...
<div id="cgu">
	...
	<form action="" method="post">
		...
		<input type="checkbox" name="cgu_agreed"/> <a href="<?php echo '../SC/terms'.(defined("IS_SUB") && IS_SUB=="1"?'-sub':'').'-'.($user_lang_iso != 'fr' ? 'en' : $user_lang_iso).'.html'; ?>" target="_blank"><?php echo _l('I accept Terms & Conditions'); ?></a><br/><br/>
		<input id="cgu_validator" type="submit" onclick="$('#cgu').hide();$('#loading').fadeIn();" value="<?php echo _l("Update"); ?>" disabled/>
	</form>
</div>
<center id="loading" style="display: none;"><br/><br/><img src="lib/img/loading.gif" alt="loading" title="loading"  /></center>
<?php } else { ?>
