...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Underline,Subscript,Superscript,Cut,Copy,Paste,PasteText,PasteFromWord,Anchor,HorizontalRule,SpecialChar,Iframe,Blockquote';
   ...
   config.filebrowserImageBrowseUrl = './lib/js/ckeditor/kcfinder/browse.php?opener=ckeditor&type=images';
