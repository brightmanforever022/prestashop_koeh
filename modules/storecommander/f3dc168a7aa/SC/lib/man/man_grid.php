...
//			console.log(cInd);
	...
	function displayManufacturers(callback, firsttime = null)
	{
		...
		if (shopselection!=undefined && shopselection!=null && shopselection!="" && shopselection!=0)
		{
			...
			man_grid.load("index.php?ajax=1&act=man_manufacturer_get&tree_mode="+tree_mode+"&manufacturerfrom="+displayManufacturersFrom+"&idshop="+shopselection+"&view="+gridView+params_supp+"&id_lang="+SC_ID_LANG+"&"+new Date().getTime(),function(){
