<?php
                ...
                if($tip->id > $id_tip) {
                    if($user_lang_iso == 'fr') {
                        $tips_notice[(int)$tip->id] = array(
                            'id' => (int)$tip->id,
                            'name' => (string)$tip->name_fr,
                            'intro' => (string)$tip->intro_fr,
                            'link' => (string)$tip->linkphoto_fr,
                            'video' => (string)$tip->video_fr,
                            'conclusion' => (string)$tip->conclusion_fr,
                            'category' => (string)$tip->category_fr
                        );
                    } else {
                        $tips_notice[(int)$tip->id] = array(
                            'id' => (int)$tip->id,
                            'name' => (string)$tip->name_en,
                            'intro' => (string)$tip->intro_en,
                            'link' => (string)$tip->linkphoto_en,
                            'video' => (string)$tip->video_en,
                            'conclusion' => (string)$tip->conclusion_en,
                            'category' => (string)$tip->category_en
                        );
                    }
                }
            }
        ...
        && !empty($tip_to_show))
    {
        ...
        if(!empty($tip_to_show['video'])) {
            $link = array(
                'lk' => 'https://www.youtube.com/embed/'.$tip_to_show['video'],
