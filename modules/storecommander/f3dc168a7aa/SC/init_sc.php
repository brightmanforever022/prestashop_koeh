...
define('SC_JSFUNCTIONS','lib/js/functions_029.js');
define('SC_JSDHTMLX','lib/js/dhtmlx_009.js');
define('SC_CSSSTYLE','lib/css/style_017.css');
...
if(!empty($licence))
{
    ...
    $call = "16";
define('IS_SUB',($call=="16"?"1":"0"));
require_once(SC_DIR.'lib/php/utf'.$call.'.php');
...
define('SC_CSSDHTMLX','lib/js/dhtmlx_012_1.css');//'./*_s('APP_SKIN_INTERFACE')*/.'

## d�sactivation du cache sur les requetes
