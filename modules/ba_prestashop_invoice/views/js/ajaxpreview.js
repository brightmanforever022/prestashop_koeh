...
jQuery(document).ready(function(){
	...
	jQuery('#form-ba_prestashop_invoice_invoice').on('click', 'a.details', function(ev){
		ev.preventDefault();
		var template_id = $(this).attr('href').match(/id=(\d+)/);
		location.href = invoiceRulesControllerUrl + '&action=search_rule_n_redirect&template_id='+template_id[1];
	});
});
