...
class ba_prestashop_invoice extends Module
{
    ...
    public function __construct()
    {
        ...
        require_once "includes/BaTemplateCategory.php";
    ...
    public function getContent()
    {
        ...
        $html='
            <script type="text/javascript">    
                ...
                var invoiceRulesControllerUrl = "'. $this->context->link->getAdminLink('AdminInvoiceRules') .'";
            </script>
...
/**
ALTER TABLE `prs_ba_prestashop_invoice` ADD `payment_type` TINYINT UNSIGNED NOT NULL AFTER `no_tax`;

ALTER TABLE `prs_ba_prestashop_invoice` ADD `agentsales_ignore` TINYINT UNSIGNED NOT NULL AFTER `require_vat`;
 */
