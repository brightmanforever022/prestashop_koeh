<?php
/**
 * File for BurgelRiskWsdlClass to communicate with SOAP service
 * @package BurgelRisk
 ...
 */
/**
 * BurgelRiskWsdlClass to communicate with SOAP service
 * Documentation : This service provides the product 'Riskcheck' in three different forms: 'standard', 'advances' and 'professional'. Please use the webservice security extension (wss) in the service header to authenticate. Only a 'UsernameToken' is needed.
 * @package BurgelRisk
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2019-03-04
 */
class BurgelRiskWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://test.buergel-online.de/b2c-ws-test/services/b2c/v2/riskcheck?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses BurgelRiskWsdlClass::setLastError()
     * @uses BurgelRiskWsdlClass::initSoapClient()
     * @uses BurgelRiskWsdlClass::initInternArrayToIterate()
     * @uses BurgelRiskWsdlClass::_set()
     ...
     * @return BurgelRiskWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'BurgelRiskWsdlClass'))
            {
     ...
     * @uses BurgelRiskClassMap::classMap()
     * @uses BurgelRiskWsdlClass::getDefaultWsdlOptions()
     * @uses BurgelRiskWsdlClass::getSoapClientClassName()
     * @uses BurgelRiskWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('BurgelRiskClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = BurgelRiskClassMap::classMap();
     ...
     * If a class is named as {BurgelRisk}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('BurgelRiskSoapClient') && is_subclass_of('BurgelRiskSoapClient','SoapClient'))
            return 'BurgelRiskSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses BurgelRiskWsdlClass::WSDL_CACHE_WSDL
     * @uses BurgelRiskWsdlClass::WSDL_COMPRESSION
     * @uses BurgelRiskWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses BurgelRiskWsdlClass::WSDL_ENCODING
     * @uses BurgelRiskWsdlClass::WSDL_EXCEPTIONS
     * @uses BurgelRiskWsdlClass::WSDL_FEATURES
     * @uses BurgelRiskWsdlClass::WSDL_LOGIN
     * @uses BurgelRiskWsdlClass::WSDL_PASSWORD
     * @uses BurgelRiskWsdlClass::WSDL_SOAP_VERSION
     * @uses BurgelRiskWsdlClass::WSDL_STREAM_CONTEXT
     * @uses BurgelRiskWsdlClass::WSDL_TRACE
     * @uses BurgelRiskWsdlClass::WSDL_TYPEMAP
     * @uses BurgelRiskWsdlClass::WSDL_URL
     * @uses BurgelRiskWsdlClass::VALUE_WSDL_URL
     * @uses BurgelRiskWsdlClass::WSDL_USER_AGENT
     * @uses BurgelRiskWsdlClass::WSDL_PROXY_HOST
     * @uses BurgelRiskWsdlClass::WSDL_PROXY_PORT
     * @uses BurgelRiskWsdlClass::WSDL_PROXY_LOGIN
     * @uses BurgelRiskWsdlClass::WSDL_PROXY_PASSWORD
     * @uses BurgelRiskWsdlClass::WSDL_LOCAL_CERT
     * @uses BurgelRiskWsdlClass::WSDL_PASSPHRASE
     * @uses BurgelRiskWsdlClass::WSDL_AUTHENTICATION
     * @uses BurgelRiskWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses BurgelRiskWsdlClass::getSoapClient()
     * @uses BurgelRiskWsdlClass::getFormatedXml()
     ...
     * @uses BurgelRiskWsdlClass::getSoapClient()
     * @uses BurgelRiskWsdlClass::convertStringHeadersToArray()
     ...
     * @uses BurgelRiskWsdlClass::count()
     * @return int
     */
     ...
     * @uses BurgelRiskWsdlClass::getInternArrayToIterate()
     * @uses BurgelRiskWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses BurgelRiskWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses BurgelRiskWsdlClass::getInternArrayToIterateOffset()
     * @uses BurgelRiskWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses BurgelRiskWsdlClass::getInternArrayToIterateOffset()
     * @uses BurgelRiskWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see BurgelRiskWsdlClass::offsetGet()
     * @uses BurgelRiskWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses BurgelRiskWsdlClass::getAttributeName()
     * @uses BurgelRiskWsdlClass::__toString()
     * @uses BurgelRiskWsdlClass::_set()
     * @uses BurgelRiskWsdlClass::_get()
     * @uses BurgelRiskWsdlClass::setInternArrayToIterate()
     * @uses BurgelRiskWsdlClass::setInternArrayToIterateIsArray()
     * @uses BurgelRiskWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses BurgelRiskWsdlClass::item()
     * @uses BurgelRiskWsdlClass::length()
     * @return mixed
     */
