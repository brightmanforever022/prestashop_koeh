	...
	<form action="{$current_url}" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="{l s='Distance in items, between same product variants in list (on page). Works for top seller sorting only.' mod='blocklayered'}" >{l s='Same products distance' mod='blocklayered'}</span>
                    </label>
			<div class="col-lg-9">
				<input type="text" name="ps_layered_filter_sort_sep_distance" value="{$sort_sep_dist}" class="fixed-width-sm" autocomplete="off" />
			</div>
		</div>
		<div class="form-group">
