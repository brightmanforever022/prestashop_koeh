...
var orderedit = {
	...
	setHandlers: function() {
		...
		$('#new_product').on('change', '#add_product_product_price_tax_excl', function(){
			var priceTE = parseFloat( $(this).val() );
			var taxValue = parseFloat( $('#add_product_product_tax_rate').val() );
			var priceTI = priceTE / 100 * taxValue + priceTE;
			$('#add_product_product_price_tax_incl').val( priceTI );
		});
	},
