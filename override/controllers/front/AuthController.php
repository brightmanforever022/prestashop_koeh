...
class AuthController extends AuthControllerCore
{
    ...
    protected function processSubmitAccount()
    {
        ...
        if(Tools::getValue('passwd') != Tools::getValue('passwd_conf')){
            $this->errors[] = Tools::displayError('Confirm password not match!');
        }
        ...
        $customer->active = Tools::getValue('reference_brand')=='ck-aktiv'?1:0;
