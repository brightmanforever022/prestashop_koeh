...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box form-horizontal">
		...
		<div class="account_creation">
            ...
            <div class="required form-group" >
    					<label class="control-label col-sm-12" for="">{l s='Company'} <sup>*</sup></label>
    					<div class="col-sm-12" >
    						<input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
    					</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-12" for="siret">{l s='VAT number'}</label>
				<div class="col-sm-12">
            ...
            <div class="form-group">
					<label class="control-label col-sm-12" for="phone_mobile_2">{l s='Mobile phone'}</label>
					<div class="col-sm-12">
						<input type="text" class="form-control" name="phone_mobile_2" id="phone_mobile_2" value="{if isset($smarty.post.phone_mobile_2)}{$smarty.post.phone_mobile_2}{/if}" />
					</div>
			</div>
