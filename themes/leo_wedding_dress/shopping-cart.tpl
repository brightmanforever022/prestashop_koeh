...
{else}
	...
	<p class="cart_navigation clearfix">
		...
		{if !$opc}
			<a id="cart_proceed_to_checkout" href="{if $back}{$link->getPageLink('order', true, NULL, 'step=1&amp;back={$back}')|escape:'html':'UTF-8'}{else}{$link->getPageLink('order', true, NULL, 'step=1')|escape:'html':'UTF-8'}{/if}" class="button btn btn-outline standard-checkout button-medium pull-right" title="{l s='Proceed to checkout'}">
