		...
		$.ajax({
			...
			success: function(jsonData,textStatus,jqXHR)
			{
				...
				if (!jsonData.hasError)
				{
					...
					$('#layer_cart_messages').empty();
					if( jsonData.nostock_nosupply_products_warnings != undefined ){
						$('#layer_cart_messages').append( $('<ul class="alert alert-danger alert-nostocknoprdc" style="margin:0;"></ul>') );
						for( var ni = 0; ni < jsonData.nostock_nosupply_products_warnings.length; ni++ ){
							$('#layer_cart_messages ul').append( 
								'<li>'+ jsonData.nostock_nosupply_products_warnings[ni] +'</li>'
							);
						}
					}
