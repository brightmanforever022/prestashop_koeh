...
function accordion(status)
{
  if(status == 'enable')
  {
	...
	$('#right_column .block, #left_column .block, #left_column #newsletter_block_left, #left_column .shopping_cart > a:first-child, #right_column .shopping_cart > a:first-child')
		.on('click', '.title_block, h4', function(e){
		$(this).toggleClass('active').parent().find('.block_content').stop().slideToggle('medium');
	});
