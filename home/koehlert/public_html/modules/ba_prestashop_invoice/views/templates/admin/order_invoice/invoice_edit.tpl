		...
		<form class="form-horizontal"  method="POST" id="form_template">
			...
			<div class="" style="padding:0 10px;width:100%;float:left;">
				...
				<div class="col-sm-12" style="margin-top:7px;">
					...
					<div class="col-sm-12" style="margin-bottom: 10px;">
						<div class="col-sm-4 control-label" style="padding:0;font-size: 13px;">{l s='Requires VAT ID' mod='ba_prestashop_invoice'}: </div>
						<div class="col-sm-5"><input type="checkbox" name="require_vat" value="1" {if $invoiceTemplate.require_vat==1}checked=checked{/if}/></div>
					</div>
					<div class="col-sm-12" style="margin-bottom: 10px;">
						<div class="col-sm-4 control-label" style="padding:0;font-size: 13px;">{l s='Ignore in agent commisions' mod='ba_prestashop_invoice'}: </div>
						<div class="col-sm-5"><input type="checkbox" name="agentsales_ignore" value="1" {if $invoiceTemplate.agentsales_ignore==1}checked=checked{/if}/></div>
					</div>
					...
					<div class="col-sm-12" style="margin-bottom: 10px;">
						<div class="col-sm-4 control-label" style="padding:0;font-size: 13px;">{l s='Invoice type' mod='ba_prestashop_invoice'}: </div>
						<div class="col-sm-2">
							<select name="payment_type" id="payment_type">
								{foreach from=$payment_type_options item=payment_type_name key=payment_type_id}
								<option {if $invoiceTemplate.payment_type==$payment_type_id}selected{/if} value="{$payment_type_id|escape:'htmlall':'UTF-8'}">{$payment_type_name|escape:'htmlall':'UTF-8'}</option>
								{/foreach}
							</select>
						</div>
					</div>
				...
				<div class="row list_token col-sm-12" rev="close" style="height:100px;overflow:hidden;margin-bottom: 20px;">
					<div class="ba_invoice_token_wrapper">
						...
						<label class="control-label">{l s='Customer discount' mod='ba_prestashop_invoice'}</label>
					</div>
