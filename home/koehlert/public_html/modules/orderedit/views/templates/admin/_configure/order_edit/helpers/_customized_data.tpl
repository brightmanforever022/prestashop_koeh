		...
		<td align="center" class="productQuantity">
				...
				<p class="realVal" style="display:none;">
					<span class="realVal product_quantity_edit" style="display:none;">
						<input type="text" rel="productCustomAllQtyEdit" class="edit_product_quantity" value="{$product['customizationQuantityTotal']|escape:'html':'UTF-8'}" size="2"  autocomplete="off" />
					</span>
				</p>
				{/if}
		</td>
			...
			<tr class="customized customized-{$product['id_order_detail']|intval} customized-prop" id="customline_{$index|escape:'html':'UTF-8'}" data-custom-prop="{$product['id_order_detail']|intval}">
				...
				<td class="productQuantity text-center">
					<div class="editable">
						...
						<p class="realVal" style="display:none;">
							<span class="realVal product_quantity_edit" style="display:none;">
								<input type="text" name="product_quantity[{$customizationId|intval}]" id-cus="{$data['id_customization']|escape:'html':'UTF-8'}" rel="productCustomQtyEdit" class="edit_product_quantity edit_customdata" value="{$customization['quantity']|htmlentities}" size="2"  autocomplete="off" />
							</span>
						</p>
						{/if}
					</div>
