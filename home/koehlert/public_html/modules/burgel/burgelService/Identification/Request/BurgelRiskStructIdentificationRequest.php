<?php
/**
 * File for class BurgelRiskStructIdentificationRequest
 * @package BurgelRisk
 * @subpackage Structs
 ...
 */
/**
 * This class stands for BurgelRiskStructIdentificationRequest originally named identificationRequest
 ...
 * @date 2019-03-04
 */
class BurgelRiskStructIdentificationRequest extends BurgelRiskWsdlClass
{
    /**
     * The name
     * @var string
    ...
    /**
     * Constructor method for identificationRequest
     ...
     * @return BurgelRiskStructIdentificationRequest
     */
    public function __construct($_name = NULL,$_dateOfBirth = NULL,$_emailAddress = NULL,$_phone = NULL,$_commercialRegisterEntry = NULL)
    {
        parent::__construct(array('name'=>$_name,'dateOfBirth'=>$_dateOfBirth,'emailAddress'=>$_emailAddress,'phone'=>$_phone,'commercialRegisterEntry'=>$_commercialRegisterEntry),false);
    }
    /**
     * Get name value
     * @return string|null
