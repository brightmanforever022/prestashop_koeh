<?php
/**
 * File for class BurgelRiskStructRequestAddress
 * @package BurgelRisk
 * @subpackage Structs
 ...
 */
/**
 * This class stands for BurgelRiskStructRequestAddress originally named requestAddress
 ...
 * @date 2019-03-04
 */
class BurgelRiskStructRequestAddress extends BurgelRiskWsdlClass
{
    /**
     * The identification
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var BurgelRiskStructIdentificationRequest
     */
    ...
    public $location;
    /**
     * Constructor method for requestAddress
     * @see parent::__construct()
     * @param BurgelRiskStructIdentificationRequest $_identification
     ...
     * @return BurgelRiskStructIdentificationRequest|null
     */
     ...
     * @param BurgelRiskStructIdentificationRequest $_identification the identification
