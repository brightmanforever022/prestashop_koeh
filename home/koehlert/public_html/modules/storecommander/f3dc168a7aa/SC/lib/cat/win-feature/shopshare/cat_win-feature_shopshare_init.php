...
wFeatures.tbAttr.addListOption('win_feat_prop_subproperties', 'win_feat_prop_shopshare', 3, "button", '<?php echo _l('Multistore sharing manager',1)?>', "lib/img/sitemap_color.png");
...
wFeatures.tbAttr.attachEvent("onClick", function(id){
	if(id=="win_feat_prop_shopshare")
	{
		...
		wFeatures.tbAttr.setItemImage('win_feat_prop_subproperties', 'lib/img/sitemap_color.png');
...
wFeatures.tbAttr.addButton('win_feature_prop_shopshare_refresh',100,'','lib/img/arrow_refresh.png','lib/img/arrow_refresh.png');
wFeatures.tbAttr.setItemToolTip('win_feature_prop_shopshare_refresh','<?php echo _l('Refresh grid',1)?>');
wFeatures.tbAttr.addButton("win_feature_prop_shopshare_add_select", 100, "", "lib/img/chart_organisation_add_v.png", "lib/img/chart_organisation_add_v.png");
...
wFeatures.tbAttr.addButton("win_feature_prop_shopshare_del_select", 100, "", "lib/img/chart_organisation_delete_v.png", "lib/img/chart_organisation_delete_v.png");
