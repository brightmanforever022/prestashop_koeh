...
<script type="text/javascript">
    ...
    dhxlTrendsShopFilters_Tb.addButton("refresh", 10, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
    dhxlTrendsShopFilters_Tb.setItemToolTip('refresh','<?php echo _l('Refresh grid')?>');
    dhxlTrendsShopFilters_Tb.addButtonSelect('trends_shop_views',0,'<?php echo _l('Filter group')?>',ts_filter_views,'lib/img/flag_blue.png','lib/img/flag_blue.png',false,true);
    ...
    dhxlTrendsShopFilters_Tree.setImagePath('lib/js/imgs/');
    ...
    dhxlTrendsShopContent_Tb.addButtonSelect('trends_shop_content_views',0,'<?php echo _l('Configuration')?>',ts_content_filter_views,'lib/img/flag_blue.png','lib/img/flag_blue.png',false,true);
    dhxlTrendsShopContent_Tb.addButton("refresh", 10, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
    dhxlTrendsShopContent_Tb.setItemToolTip('refresh','<?php echo _l('Refresh grid')?>');
    dhxlTrendsShopContent_Tb.addButton("exportcsv", 10, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
