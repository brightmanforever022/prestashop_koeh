 ...
 *
 **/
$colSettings['id_partner']=array('text' => _l('ID'),'width'=>40,'align'=>'right','type'=>'ro','sort'=>'int','color'=>'','filter'=>'#numeric_filter','footer'=>'#stat_count');
...
$colSettings['customer_id']=array('text' => _l('ID'),'width'=>50,'align'=>'right','type'=>'edtxt','sort'=>'int','color'=>'','filter'=>'#numeric_filter');
...
$colSettings['mode']=array('text' => _l('Mode'),'width'=>80,'type'=>'coro','align'=>'right','sort'=>'','color'=>'','filter'=>'#select_filter','options'=>array('unlimited'=>_l('Unlimited'),'limited'=>_l('Limited'),'firstorder'=>_l('First order')));
