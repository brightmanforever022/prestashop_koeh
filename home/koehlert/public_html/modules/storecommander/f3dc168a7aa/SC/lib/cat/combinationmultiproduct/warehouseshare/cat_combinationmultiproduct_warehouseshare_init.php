...
prop_tb.attachEvent("onClick", function setPropertiesPanel_combinationmultiproduct(id){
	...
	{
		prop_tb.combimulprd_subproperties_tb.addListOption('combimulprdSubProperties', 'combimulprd_warehouses', 9, "button", '<?php echo _l('Warehouses',1)?>', "lib/img/building.png");
		...
		prop_tb.combimulprd_subproperties_tb.attachEvent("onClick", function(id){
			if(id=="combimulprd_warehouses")
			{
				...
				prop_tb.combimulprd_subproperties_tb.setItemImage('combimulprdSubProperties', 'lib/img/building.png');
		...
		prop_tb.combimulprd_subproperties_tb.addButton("warehouseshare_refresh", 100, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
		prop_tb.combimulprd_subproperties_tb.setItemToolTip('warehouseshare_refresh','<?php echo _l('Refresh grid',1)?>');
		prop_tb.combimulprd_subproperties_tb.addButton("warehouseshare_add_select", 100, "", "lib/img/building_add.png", "lib/img/building_add.png");
		...
		prop_tb.combimulprd_subproperties_tb.addButton("warehouseshare_del_select", 100, "", "lib/img/building_delete.png", "lib/img/building_delete.png");
...
function initCombinationMultiProductWarehouseshare()
{
	...
	/*prop_tb._combinationmultiproductWarehousesGrid.enableAutoSaving('cg_cat_warehouseshare_combi',"expires=Fri, 31-Dec-2021 23:59:59 GMT");
	prop_tb._combinationmultiproductWarehousesGrid.enableAutoHiddenColumnsSaving('cg_cat_warehouseshare_combimulprd_col',"expires=Fri, 31-Dec-2021 23:59:59 GMT");*/
