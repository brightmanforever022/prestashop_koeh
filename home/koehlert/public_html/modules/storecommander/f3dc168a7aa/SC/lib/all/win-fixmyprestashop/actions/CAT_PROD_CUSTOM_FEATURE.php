...
if(!empty($post_action) && $post_action=="do_check")
{
	...
	if(!empty($values) && count($values)>0)
	{
		...
		<script type="text/javascript">
			...
			tbCustomFeature.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
			tbCustomFeature.setItemToolTip('selectall','<?php echo _l('Select all')?>');
			tbCustomFeature.addButton("add", 0, "", "lib/img/table_multiple.png", "lib/img/table_multiple.png");
			...
			dhxlSCExtCheck.tabbar.cells("table_CAT_PROD_CUSTOM_FEATURE").attachStatusBar({text: '<?php echo _l('Count rows:')." ".count($res) ; ?>', height: 25 });
