...
wFeatures.tbAttr.addListOption('win_feat_prop_subproperties', 'win_feat_prop_featurevalues', 1, "button", '<?php echo $propname; ?>', "lib/img/description.png");
...
wFeatures.tbAttr.attachEvent("onClick", function(id){
	if(id=="win_feat_prop_featurevalues")
	{
		...
		wFeatures.tbAttr.setItemImage('win_feat_prop_subproperties', 'lib/img/description.png');
...
wFeatures.tbAttr.addButton("refresh", 100, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
...
wFeatures.tbAttr.addButton("add_attr", 100, "", "lib/img/add.png", "lib/img/add.png");
wFeatures.tbAttr.setItemToolTip('add_attr','<?php echo _l('Create new feature value')?>');
wFeatures.tbAttr.addButton("del_attr", 100, "", "lib/img/delete.gif", "lib/img/delete.gif");
wFeatures.tbAttr.setItemToolTip('del_attr','<?php echo _l('Delete selected values')?>');
wFeatures.tbAttr.addButton("merge_feat", 100, "", "lib/img/shape_move_front.png", "lib/img/shape_move_front.png");
...
if (isIPAD)
{
    wFeatures.tbAttr.addButtonTwoState('lightNavigation', 100, "", "lib/img/cursor.png", "lib/img/cursor.png");
