...
if(!empty($post_action) && $post_action=="do_check")
{
	...
	if(!empty($res) && count($res)>0)
	{
		...
		<script type="text/javascript">
			...
			tbCurrentState.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
			tbCurrentState.setItemToolTip('selectall','<?php echo _l('Select all')?>');
			tbCurrentState.addButton("replace", 0, "", "lib/img/cog_edit.png", "lib/img/cog_edit.png");
			...
			dhxlSCExtCheck.tabbar.cells("table_CMD_STA_CURRENT_STATE").attachStatusBar({text: '<?php echo _l('Count rows:')." ".count($res) ; ?>', height: 25 });
