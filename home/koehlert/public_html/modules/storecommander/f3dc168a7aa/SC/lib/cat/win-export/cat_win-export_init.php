...
<script type="text/javascript">
	...
	wExport.tbOptions.addButton("go_to_settings", 0, "", "lib/img/cog_edit.png", "lib/img/cog_edit.png");
    wExport.tbOptions.setItemToolTip('go_to_settings','<?php echo _l('Open settings')?>');
...
?>
			...
			if (wExport.gridMapping.cells(rId,idxDBField).getValue()=='priceinctaxwithshipping') {
				...
				<?php
                    $carriers = Carrier::getCarriers(SC_ID_LANG, true,false,false,null,Carrier::ALL_CARRIERS);
...
//		wExport.treeCategories.load("index.php?ajax=1&act=cat_win-export_categ_get&id_lang="+SC_ID_LANG+"&"+new Date().getTime(),function(){
