...
{
    if (version_compare($moduleInstance->version, '1.2.8', '<='))
    {
        if (is_callable(array($moduleInstance, 'clearCacheFromSC')))
            call_user_func(array($moduleInstance, 'clearCacheFromSC'));
    }else{
