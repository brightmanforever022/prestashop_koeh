...
if(!empty($post_action) && $post_action=="do_check")
{
    ...
    if(!empty($res) && count($res)>0)
    {
        ...
        <script type="text/javascript">
            ...
            tbLeftProductAssociationShop.addButton("selectAll", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
            tbLeftProductAssociationShop.setItemToolTip('selectAll','<?php echo _l('Select all')?>');
            tbLeftProductAssociationShop.addButton("replaceIdDefaultShop", 0, "", "lib/img/cog_go.png", "lib/img/cog_go.png");
            ...
            dhxlSCExtCheck.tabbar.cells("table_CAT_PRODUCT_ASSOCIATION_SHOP").attachStatusBar({text: '<?php echo _l('Count rows:')." ".count($res) ; ?>', height: 25 });
