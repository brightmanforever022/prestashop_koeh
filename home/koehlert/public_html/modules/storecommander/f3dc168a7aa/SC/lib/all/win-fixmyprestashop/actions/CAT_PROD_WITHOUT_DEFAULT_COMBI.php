...
if(!empty($post_action) && $post_action=="do_check")
{
	...
	if(!empty($res) && count($res)>0)
	{
		...
		<script type="text/javascript">
			...
			tbNoDefaultCombi.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
			tbNoDefaultCombi.setItemToolTip('selectall','<?php echo _l('Select all')?>');
			tbNoDefaultCombi.addButton("add", 0, "", "lib/img/add.png", "lib/img/add.png");
			...
			dhxlSCExtCheck.tabbar.cells("table_CAT_PROD_WITHOUT_DEFAULT_COMBI").attachStatusBar({text: '<?php echo _l('Count rows:')." ".count($res) ; ?>', height: 25 });
