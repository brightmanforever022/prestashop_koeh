...
if(!empty($post_action) && $post_action=="do_check")
{
    $sql = "SELECT pa.id_product, pa.id_product_attribute, pp.id_shop_default AS id_product_shop_default
            ...
            LEFT JOIN "._DB_PREFIX_."product pp ON (pp.id_product = pa.id_product)
    ...
    if(!empty($res) && count($res)>0)
    {
        ...
        <script type="text/javascript">
            ...
            tbLeftProductAttrAssociationShop.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
            tbLeftProductAttrAssociationShop.setItemToolTip('selectall','<?php echo _l('Select all')?>');
            tbLeftProductAttrAssociationShop.addButton("replaceIdDefaultShop", 0, "", "lib/img/cog_go.png", "lib/img/cog_go.png");
            ...
            xml = xml+'	<userdata name="ids"><?php echo $row['id_product_attribute']."_".$row['id_shop_default'] ?></userdata>';
            ...
            dhxlSCExtCheck.tabbar.cells("table_CAT_ATTR_ASSOCIATION_SHOP").attachStatusBar({text: '<?php echo _l('Count rows:')." ".count($res) ; ?>', height: 25 });
            ...
            tbRightProductAssociationShop.addButton("replaceIdDefaultShopWithSelected", 0, "", "lib/img/cog_go.png", "lib/img/cog_go.png");
