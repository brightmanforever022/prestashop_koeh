...
prop_tb.attachEvent("onClick", function setPropertiesPanel_combinations(id){
    if (id=='combinations')
	{
		prop_tb.combi_subproperties_tb.addListOption('combiSubProperties', '<?php echo $subprop_name; ?>', 9, "button", '<?php echo $subprop_title; ?>', "lib/img/<?php echo $icon; ?>");
        ...
        prop_tb.combi_subproperties_tb.attachEvent("onClick", function(id){
			if(id=="<?php echo $subprop_name; ?>")
			{
				...
				prop_tb.combi_subproperties_tb.setItemImage('combiSubProperties', 'lib/img/<?php echo $icon; ?>');
        ...
        prop_tb.combi_subproperties_tb.addButton("stats_refresh", 100, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
        ...
        prop_tb.combi_subproperties_tb.addButtonSelect('options_view',100,'<?php echo _l('Total amount of combinations sold')?>',options_stats_view,'lib/img/flag_blue.png','lib/img/flag_blue.png',false,true);
...
function getCombinationStats(){
    prop_tb._combinationsStatLayout.cells('a').attachURL('index.php?ajax=1&act=cat_combination_stats_get&stat_view='+options_stats_view_selected+'&id_product_attribute='+prop_tb._combinationsGrid.getSelectedRowId(),true);
}