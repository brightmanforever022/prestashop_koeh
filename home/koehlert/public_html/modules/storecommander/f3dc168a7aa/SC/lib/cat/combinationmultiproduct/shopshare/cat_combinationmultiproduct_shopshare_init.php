...
prop_tb.attachEvent("onClick", function setPropertiesPanel_combinationmultiproduct(id){
	...
	{
		prop_tb.combimulprd_subproperties_tb.addListOption('combimulprdSubProperties', 'combimulprd_shop', 9, "button", '<?php echo _l('Multistore sharing manager',1)?>', "lib/img/sitemap_color.png");
		...
		prop_tb.combimulprd_subproperties_tb.attachEvent("onClick", function(id){
			if(id=="combimulprd_shop")
			{
				...
				prop_tb.combimulprd_subproperties_tb.setItemImage('combimulprdSubProperties', 'lib/img/sitemap_color.png');
		...
		prop_tb.combimulprd_subproperties_tb.addButton("shopshare_refresh", 100, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
		prop_tb.combimulprd_subproperties_tb.setItemToolTip('shopshare_refresh','<?php echo _l('Refresh grid',1)?>');
		prop_tb.combimulprd_subproperties_tb.addButton("shopshare_add_select", 100, "", "lib/img/building_add.png", "lib/img/building_add.png");
		...
		prop_tb.combimulprd_subproperties_tb.addButton("shopshare_del_select", 100, "", "lib/img/building_delete.png", "lib/img/building_delete.png");
