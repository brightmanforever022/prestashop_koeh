...
if(!empty($post_action) && $post_action=="do_check")
{
    ...
    if(!empty($res) && count($res)>0)
    {
        ...
        <script type="text/javascript">
            ...
            tbGhostCombiStockAvailable.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
            tbGhostCombiStockAvailable.setItemToolTip('selectall','<?php echo _l('Select all')?>');
            tbGhostCombiStockAvailable.addButton("delete", 0, "", "lib/img/building_edit.png", "lib/img/building_edit.png");
            ...
            dhxlSCExtCheck.tabbar.cells("table_CAT_STK_TOO_MUCH_COMBI_STOCK_AVAILABLE").attachStatusBar({text: '<?php echo _l('Count rows:')." ".count($res) ; ?>', height: 25 });
