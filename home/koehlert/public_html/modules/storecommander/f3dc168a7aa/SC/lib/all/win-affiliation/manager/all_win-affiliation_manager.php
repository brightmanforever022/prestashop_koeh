<script type="text/javascript">
	...
	dhxlAffPartners.toolbar.addButton("color_help", 0, "", "lib/img/help.png", "lib/img/help.png");
	dhxlAffPartners.toolbar.setItemToolTip('color_help','<?php echo _l('Show help for color codes used', 1)?>');
	dhxlAffPartners.toolbar.addButton("export_grid", 0, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
	...
	dhxlAffPartners.toolbar.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
	dhxlAffPartners.toolbar.setItemToolTip('selectall','<?php echo _l('Select all', 1)?>');
	dhxlAffPartners.toolbar.addButton("user_go", 0, "", "lib/img/user_orange_go.png", "lib/img/user_orange_go.png");
	dhxlAffPartners.toolbar.setItemToolTip('user_go','<?php echo _l('Login as selected user on the front office', 1)?>');
	dhxlAffPartners.toolbar.addButton("history_partner", 0, "", "lib/img/application_view_list.png", "lib/img/application_view_list.png");
	dhxlAffPartners.toolbar.setItemToolTip('history_partner','<?php echo _l('Show ChangeLog', 1)?>');
	dhxlAffPartners.toolbar.addButton("reset_ppa", 0, "", "lib/img/accept_grey.png", "lib/img/accept_grey.png");
	dhxlAffPartners.toolbar.setItemToolTip('reset_ppa','<?php echo _l('Reset agreements of all partners', 1)?>');
	dhxlAffPartners.toolbar.addButton("coupon_partner_remove", 0, "", "lib/img/tag_blue_delete.png", "lib/img/tag_blue_delete.png");
	dhxlAffPartners.toolbar.setItemToolTip('coupon_partner_remove','<?php echo _l('Remove coupon', 1)?>');
	dhxlAffPartners.toolbar.addButton("coupon_partner", 0, "", "lib/img/tag_blue_edit.png", "lib/img/tag_blue_edit.png");
	dhxlAffPartners.toolbar.setItemToolTip('coupon_partner','<?php echo _l('Edit discount coupon', 1)?>');
	dhxlAffPartners.toolbar.addButton("chart_partner", 0, "", "lib/img/chart_bar.png", "lib/img/chart_bar.png");
	dhxlAffPartners.toolbar.setItemToolTip('chart_partner','<?php echo _l('Performance', 1)?>');
	dhxlAffPartners.toolbar.addButton("del_partner", 0, "", "lib/img/delete.gif", "lib/img/delete.gif");
	dhxlAffPartners.toolbar.setItemToolTip('del_partner','<?php echo _l('Delete partner', 1)?>');
	dhxlAffPartners.toolbar.addButton("add_partner", 0, "", "lib/img/add.png", "lib/img/add.png");
	dhxlAffPartners.toolbar.setItemToolTip('add_partner','<?php echo _l('New partner', 1)?>');
	dhxlAffPartners.toolbar.addButton("refresh", 0, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
	...
	dhxlAffPartners.toolbar.attachEvent("onClick",
		function(id){
			...
			if (id=='user_go'){
				...
				if (sel)
				{
					...
					if (tabId.length==1){
                        ...
                        <?php } ?>
                        connectAsUser("<?php echo Configuration::get('SC_FOLDER_HASH');?>","<?php echo $sc_agent->id_employee; ?>",id_customer,id_shop);
					}else{
			...
			if (id=='add_partner')
			{
                ...
                dhxlAffPartners.grid.addRow(newId,[newId,<?php if(SCMS) echo "''," ?>'1','','','','','','code','10.00','','','unlimited', '', '0', '0', '0','','']);
                //displayAffiliation();
			}
			if (id=='del_partner')
			{
			...
			if (id=='history_partner' && selectedPartnerIds!="")
			{
				if (!dhxWins.isWindow("wAffHistory"))
				{
					...
					wAffHistory.setIcon('lib/img/application_view_list.png','lib/img/application_view_list.png');
	...
	//dhxlAffPartners.grid.enableSmartRendering(true);
	...
	function onGridAffPartnersContextButtonClick(itemId){
		tabId=dhxlAffPartners.grid.contextID;
		tabId=tabId[0];
		if (itemId=="copy"){
	...
	dhxlAffPartners.grid.attachEvent("onBeforeContextMenu", function(rowid,colidx,grid){
		var disableOnCols=new Array(
				...
				//dhxlAffPartners.grid.getColIndexById('date_add'),
	...
	dhxlAffAffiliates.toolbar.addButton("color_help", 0, "", "lib/img/help.png", "lib/img/help.png");
	dhxlAffAffiliates.toolbar.setItemToolTip('color_help','<?php echo _l('Show help for color codes used', 1)?>');
	dhxlAffAffiliates.toolbar.addButton("export_grid", 0, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
	...
	dhxlAffAffiliates.toolbar.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
	dhxlAffAffiliates.toolbar.setItemToolTip('selectall','<?php echo _l('Select all', 1)?>');
	dhxlAffAffiliates.toolbar.addButton("del_aff", 0, "", "lib/img/delete.gif", "lib/img/delete.gif");
	dhxlAffAffiliates.toolbar.setItemToolTip('del_aff','<?php echo _l('Delete affiliate', 1)?>');
	dhxlAffAffiliates.toolbar.addButton("openps", 0, "", "lib/img/user_ps.png", "lib/img/user_ps.png");
	dhxlAffAffiliates.toolbar.setItemToolTip('openps','<?php echo _l('Open customer page in Prestashop', 1)?>');
	dhxlAffAffiliates.toolbar.addButton("add_affiliate", 0, "", "lib/img/add.png", "lib/img/add.png");
	dhxlAffAffiliates.toolbar.setItemToolTip('add_affiliate','<?php echo _l('New affiliate', 1)?>');
	dhxlAffAffiliates.toolbar.addButton("refresh", 0, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
	...
	affiliationDataProcessor_affiliates.attachEvent("onAfterUpdate",function(sid,action,tid,xml_node){
	...
	function onGridAffPartnersAffContextButtonClick(itemId){
		tabId=dhxlAffAffiliates.grid.contextID;
		tabId=tabId[0];
		if (itemId=="copy"){
	...
	dhxlAffAffiliates.grid.attachEvent("onBeforeContextMenu", function(rowid,colidx,grid){
		var disableOnCols=new Array(
				...
				//dhxlAffAffiliates.grid.getColIndexById('scaff_partner_date_add'),
	...
	dhxlAffCommissions.toolbar.addButton("color_help", 0, "", "lib/img/help.png", "lib/img/help.png");
	dhxlAffCommissions.toolbar.setItemToolTip('color_help','<?php echo _l('Show help for color codes used', 1)?>');
	dhxlAffCommissions.toolbar.addButton("paid", 0, "", "lib/img/money_add.png", "lib/img/money_add.png");
	dhxlAffCommissions.toolbar.setItemToolTip('paid','<?php echo _l('Pay all these invoiced commissions', 1)?>');
	dhxlAffCommissions.toolbar.addButton("export_grid", 0, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
	...
	dhxlAffCommissions.toolbar.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png");
	dhxlAffCommissions.toolbar.setItemToolTip('selectall','<?php echo _l('Select all', 1)?>');
	dhxlAffCommissions.toolbar.addButton("del_comm", 0, "", "lib/img/delete.gif", "lib/img/delete.gif");
	dhxlAffCommissions.toolbar.setItemToolTip('del_comm','<?php echo _l('Delete commission', 1)?>');
	dhxlAffCommissions.toolbar.addButton("add_comm", 0, "", "lib/img/add.png", "lib/img/add.png");
	dhxlAffCommissions.toolbar.setItemToolTip('add_comm','<?php echo _l('New commission', 1)?>');
	dhxlAffCommissions.toolbar.addButton("refresh", 0, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
	...
	dhxlAffCommissions.toolbar.attachEvent("onClick",
		function(id){
			...
			if (id=='add_comm')
			{
				...
				dhxlAffCommissions.grid.addRow(newId,[newId,<?php if(SCMS) echo "''," ?>partner_id,'','<?php echo date("Y-m-d"); ?>','<?php echo _l('Awaiting invoice', 1)?>','0.0','0']);
				colorCommissions();
			}
			if (id=='del_comm')
			{
	...
	function askPartnerForComm(prefix)
	{
		...
		if(partner!=null)
		{
			...
			else
			{
				...
				affiliationDataProcessor_commissions.serverProcessor=affiliationDataProcessor_commissionsURLBase;
				var newId = new Date().getTime();
				dhxlAffCommissions.grid.addRow(newId,[newId,<?php if(SCMS) echo "''," ?>partner,'','<?php echo date("Y-m-d"); ?>','<?php echo _l('Awaiting invoice', 1)?>','0.0'],1);
			}
		}
	}
	...
	//affiliationDataProcessor_commissions.enablePartialDataSend(true);
	...
	dhxlAffOrders.toolbar.addButton("color_help", 0, "", "lib/img/help.png", "lib/img/help.png");
	dhxlAffOrders.toolbar.setItemToolTip('color_help','<?php echo _l('Show help for color codes used', 1)?>');
	dhxlAffOrders.toolbar.addButton("export_grid", 0, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
	...
	dhxlAffOrders.toolbar.addButton("selectall", 0, "", "lib/img/application_lightning.png", "lib/img/application_lightning.png", 1);
	dhxlAffOrders.toolbar.setItemToolTip('selectall','<?php echo _l('Select all', 1)?>');
	dhxlAffOrders.toolbar.addButton("openps", 0, "", "lib/img/cart_ps.png", "lib/img/cart_ps.png");
	dhxlAffOrders.toolbar.setItemToolTip('openps','<?php echo _l('Open order in Prestashop', 1)?>');
	dhxlAffOrders.toolbar.addButton("refresh", 0, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
...
function displayAffiliation()
{
	...
	dhxlAffPartners.grid.loadXML("index.php?ajax=1&act=all_win-affiliation_manager_get&id_lang="+SC_ID_LANG+"&"+new Date().getTime(),function()
		{
...
function displayAffiliates(ids)
{
	...
	dhxlAffAffiliates.grid.loadXML("index.php?ajax=1&act=all_win-affiliation_manager_affiliates_get&ids="+ids+"&id_lang="+SC_ID_LANG+"&"+new Date().getTime(),function()
    {
...
function displayCommissions(ids)
{
	...
	dhxlAffCommissions.grid.loadXML("index.php?ajax=1&act=all_win-affiliation_manager_commissions_get&ids="+ids+"&id_lang="+SC_ID_LANG+"&"+new Date().getTime(),function()
	{
...
function showColorHelp()
{
	if (!dhxWins.isWindow("wHelpAff"))
	{
		...
		wHelpAff.setIcon('lib/img/help.png','lib/img/help.png');
