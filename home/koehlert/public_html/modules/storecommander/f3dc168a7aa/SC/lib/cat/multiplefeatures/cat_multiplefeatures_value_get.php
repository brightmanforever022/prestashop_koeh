<?php
	...
	if ($filter)
	{
		...
		foreach ($res AS $val)
		{
			$featuresSelection[]=intval($val['id_feature_value']);
		}
	}
	...
	function getValues()
	{
		global $idlist,$id_lang,$used, $cntProducts, $feature_values,$hasPosition;
...
//		if(!empty($hasPosition))
//			usort($feature_values, "sortPosition");
...
<call command="attachHeader"><param><![CDATA[#text_filter,,#text_filter<?php if(!empty($hasPosition)) echo ","; ?>]]></param></call>
</afterInit>
</head>
<?php
	getValues();
