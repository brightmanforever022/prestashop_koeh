 ...
 **/
 if(version_compare(_PS_VERSION_, '1.5.0.0', '>=')) { ?>
	...
	prop_tb.attachEvent("onClick", function setPropertiesPanel_combinationmultiproduct(id){
		...
		{
			prop_tb.combimulprd_subproperties_tb.addListOption('combimulprdSubProperties', 'combimulprd_suppliers', 9, "button", '<?php echo _l('Suppliers',1)?>', "lib/img/package.png");
			...
			prop_tb.combimulprd_subproperties_tb.attachEvent("onClick", function(id){
				if(id=="combimulprd_suppliers")
				{
					...
					prop_tb.combimulprd_subproperties_tb.setItemImage('combimulprdSubProperties', 'lib/img/package.png');
			...
			prop_tb.combimulprd_subproperties_tb.addButton("supplier_refresh", 100, "", "lib/img/arrow_refresh.png", "lib/img/arrow_refresh.png");
			prop_tb.combimulprd_subproperties_tb.setItemToolTip('supplier_refresh','<?php echo _l('Refresh grid',1)?>');
			prop_tb.combimulprd_subproperties_tb.addButton("supplier_add_select", 100, "", "lib/img/chart_organisation_add_v.png", "lib/img/chart_organisation_add_v.png");
			...
			prop_tb.combimulprd_subproperties_tb.addButton("supplier_del_select", 100, "", "lib/img/chart_organisation_delete_v.png", "lib/img/chart_organisation_delete_v.png");
