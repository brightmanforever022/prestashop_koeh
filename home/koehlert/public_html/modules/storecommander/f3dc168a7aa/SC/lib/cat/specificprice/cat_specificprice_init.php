...
?>
    ...
    prop_tb.addButton("specificprice_export_grid", 12, "", "lib/img/page_excel.png", "lib/img/page_excel.png");
	...
	prop_tb.addButton("specificprice_selectall", 11, "", "lib/img/application_lightning.png", "lib/img/application_lightning_dis.png");
	prop_tb.setItemToolTip('specificprice_selectall','<?php echo _l('Select all',1)?>');
	prop_tb.addButton('specificprice_del',10,'','lib/img/delete.gif','lib/img/delete.gif');
	prop_tb.setItemToolTip('specificprice_del','<?php echo _l('Delete selected item',1)?>');
	prop_tb.addButton('specificprice_add',9,'','lib/img/add.png','lib/img/add.png');
	prop_tb.setItemToolTip('specificprice_add','<?php echo _l('Create new specific price',1)?>');
	prop_tb.addButtonTwoState('specificprice_lightNavigation', 8, "", "lib/img/cursor.png", "lib/img/cursor.png");
	prop_tb.setItemToolTip('specificprice_lightNavigation','<?php echo _l('Light navigation (simple click on grid)',1)?>');
	prop_tb.addButton('specificprice_refresh',7,'','lib/img/arrow_refresh.png','lib/img/arrow_refresh.png');
