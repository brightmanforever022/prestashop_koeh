...
<div class="row" style="padding:5px">
	<div class="col-lg-12" style="text-align:center">
		...
		*}
		<span class="ta_form_loader" style="display:none" id="ta_form_loader_manual_perform"/>
		...
		<div class="col-lg-12">
			<div class="panel">
				...
				<div class="panel-content" style="display:none">
					...
					<span class="ta_form_loader" style="display:none"/>
								...
								{if $type == constant('Product::CUSTOMIZE_FILE')}
									...
									{foreach from=$datas key='index' item='data'}
											<li style="display: inline; margin: 2px;">
												<a href="displayImage.php?img={$data.value|escape:'quotes'}-file{$index|escape:'quotes':'UTF-8'}" target="_blank">
