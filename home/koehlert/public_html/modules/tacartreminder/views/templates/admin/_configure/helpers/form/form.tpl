...
{block name="field"}
	...
	{else if $input.type == 'datetime' && $ps_version < "1.6"}
			<div class="form-group row">
				...
				<div class="row">
					<div class="input-group col-lg-4" class="form-group">
						<input id="{$input.name|escape:'html'}" type="text" data-hex="true" class="datetimepicker" name="{$input.name|escape:'html'}" value="{$fields_value[$input.name]|escape:'html':'UTF-8'}">
						<span class="input-group-addon">
							<i class="flaticon-calendar146"></i>
						</span>
					</div>
	...
	{else if $input.type == 'force_reminder'}
	...
	{else if $input.type == 'textarea' && $input.name == 'content_html'}
	
	<div id="content_mail_template">
		{$smarty.block.parent}
	</div>
	{else if $input.type == 'example_mails'}
	...
	{else if $input.type == 'convert_html_to_txt'}
	{if $ps_version < "1.6"}
	...
	{/if}	
	{else if $input.type == 'preview_mail'}
	{if $ps_version < "1.6"}
		<label>
			<span >
	...
	<div class="form-group">
			...
			<div class="col-lg-12">
				<!--div class="col-lg-6">
					<select name="cart_mail_preview" id="cart_mail_preview">
						{foreach from=$cart_mails item='cart_mail'}
							<option value="{$cart_mail.id_cart|intval}">{$cart_mail.date_add|escape:'htmlall'} {$cart_mail.id_cart|intval} - {$cart_mail.firstname|escape:'htmlall':'UTF-8'} {$cart_mail.lastname|escape:'htmlall':'UTF-8'} - {$cart_mail.iso_code|escape:'htmlall':'UTF-8'}</option>									
						{/foreach}
					</select>
				</div>
				<div class="col-lg-6"-->
