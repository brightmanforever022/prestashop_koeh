...
<div id="egmail-panels" class="bootstrap ta-to-bootstrap ta-form" style="margin: 5px;padding: 0;" >
	<div id="egmail-custom" class="{if $mode=='egmail'}col-xs-8 col-sm-9 col-lg-10{else}col-lg-12{/if} ta-content-box">
		...
		<div class="row egmail" id="viewreportcontainer">
			<div id="resizer">
				<div class="ta_form_loader" style="display:none;text-align:center"/>
			...
			<div class="ta-tool-box-panel clearfix">
				...
				{foreach from=$egmail->suggestions item='suggestion' name='suggestionitem'}
					<li data-suggestion-index="{$smarty.foreach.suggestionitem.index|intval}">
						...
						<span style="background-color:{$suggestion->palette_color1|escape:'html':'UTF-8'}"/>
						<span style="background-color:{$suggestion->palette_color2|escape:'html':'UTF-8'}"/>
						<span style="background-color:{$suggestion->palette_color3|escape:'html':'UTF-8'}"/>
						<span style="background-color:{$suggestion->palette_color4|escape:'html':'UTF-8'}"/>
						<span style="background-color:{$suggestion->palette_color5|escape:'html':'UTF-8'}"/>
						<span style="background-color:{$suggestion->palette_color6|escape:'html':'UTF-8'}"/>
						</div>
					</li>									
				{/foreach}
				</ul>
