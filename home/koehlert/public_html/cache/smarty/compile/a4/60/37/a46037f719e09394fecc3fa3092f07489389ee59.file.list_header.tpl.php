<?php /* Smarty version Smarty-3.1.19, created on 2019-09-03 13:04:35
         compiled from "/home/koehlert/public_html/modules/product_list/views/templates/admin/diff_payments/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20929020785d5a491e7696b1-20262348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a46037f719e09394fecc3fa3092f07489389ee59' => 
    array (
      0 => '/home/koehlert/public_html/modules/product_list/views/templates/admin/diff_payments/helpers/list/list_header.tpl',
      1 => 1567508616,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20929020785d5a491e7696b1-20262348',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5d5a491e97c707_44096749',
  'variables' => 
  array (
    'ajax' => 0,
    'is_order_position' => 0,
    ...
    'reminder3Days' => 0,
    'reminder2Fee' => 0,
    'sumsToPayByReminderState' => 0,
    'sumToPayByState' => 0,
    'invoice_payment_type_options' => 0,
    'invoice_payment_type_selected' => 0,
    'use_overflow' => 0,
    'table_id' => 0,
    'table_dnd' => 0,
    'params' => 0,
...
<?php if ($_valid && !is_callable('content_5d5a491e97c707_44096749')) {function content_5d5a491e97c707_44096749($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/koehlert/public_html/tools/smarty/plugins/function.math.php';
...
<?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['toolbar_btn']->value)&&count($_smarty_tpl->tpl_vars['toolbar_btn']->value)>0) {?>
				...
				<?php echo smartyTranslate(array('s'=>'Sum to pay total','mod'=>'product_list'),$_smarty_tpl);?>

				<span class="badge"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['sumToPayTotal']->value),$_smarty_tpl);?>
</span>
				<button class="btn" onclick="$('#sumsToPayByReminderStateContainer').show()" type="button"><?php echo smartyTranslate(array('s'=>'Details'),$_smarty_tpl);?>
</button>
				<span class="panel-heading-action">
                                    <a class="list-toolbar-btn" href="#" onClick="$('#remindersConfig').toggle('slow'); return false;" >
                                        <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Config reminders'),$_smarty_tpl);?>
                                    ...
                                    $('#remindersConfigSaveBtn').click(function(){
                                        ...
                                        $.post(ajaxActionBaseUrl+'SaveRemindersCfg', $('#remindersConfig input').serialize(),
                                                    function(result){
                                                        ...
                                                        {
                                                            showSuccessMessage('<?php echo smartyTranslate(array('s'=>'Reminders configuration saved'),$_smarty_tpl);?>
');
                                                            setTimeout(function(){
            ...
            <div id="remindersConfig" style="display:none">
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<?php echo smartyTranslate(array('s'=>'Number of days from due date till 1st reminder'),$_smarty_tpl);?>
" >
                            <?php echo smartyTranslate(array('s'=>'Days till 1st reminder'),$_smarty_tpl);?>

                        </span>
                    </label>
                        <div class="col-lg-1 ">
                            <input name="reminder1Days" value="<?php echo $_smarty_tpl->tpl_vars['reminder1Days']->value;?>
" class="" required="required" type="text" autocomplete="off">
                        </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<?php echo smartyTranslate(array('s'=>'Number of days from 1st reminder date till 2nd reminder'),$_smarty_tpl);?>
" >
                            <?php echo smartyTranslate(array('s'=>'Days till 2nd reminder'),$_smarty_tpl);?>

                        </span>
                    </label>
                        <div class="col-lg-1 ">
                            <input name="reminder2Days" value="<?php echo $_smarty_tpl->tpl_vars['reminder2Days']->value;?>
" class="" required="required" type="text" autocomplete="off">
                        </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<?php echo smartyTranslate(array('s'=>'Number of days from 2nd till 3st reminder'),$_smarty_tpl);?>
" >
                            <?php echo smartyTranslate(array('s'=>'Days till 3rd reminder'),$_smarty_tpl);?>

                        </span>
                    </label>
                        <div class="col-lg-1 ">
                            <input name="reminder3Days" value="<?php echo $_smarty_tpl->tpl_vars['reminder3Days']->value;?>
" class="" required="required" type="text" autocomplete="off">
                        </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<?php echo smartyTranslate(array('s'=>'Fee to add to invoice when 2nd reminder sent, 0 to disable'),$_smarty_tpl);?>
" >
                            <?php echo smartyTranslate(array('s'=>'2nd reminder fee'),$_smarty_tpl);?>

                        </span>
                    </label>
                    <div class="col-lg-1 ">
                        <input name="reminder2Fee" value="<?php echo $_smarty_tpl->tpl_vars['reminder2Fee']->value;?>
" class="" required="required" type="text" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        ...
                        <div class="col-lg-4 ">
                            <button class="btn btn-default" id="remindersConfigSaveBtn"><?php echo smartyTranslate(array('s'=>'Save'),$_smarty_tpl);?>
</button>
                            <button class="btn btn-default" onClick="$('#remindersConfig').toggle('slow'); return false;"><?php echo smartyTranslate(array('s'=>'Hide'),$_smarty_tpl);?>
</button>
                        </div>
                </div>
            </div>
    ...
    <div id="sumsToPayByReminderStateContainer" style="display:none;width:30%;">
    	<table class="table">
    	<?php  $_smarty_tpl->tpl_vars['sumToPayByState'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['sumToPayByState']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['sumsToPayByReminderState']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['sumToPayByState']->key => $_smarty_tpl->tpl_vars['sumToPayByState']->value) {
$_smarty_tpl->tpl_vars['sumToPayByState']->_loop = true;
?>
    		<tr>
    			<td><?php echo $_smarty_tpl->tpl_vars['sumToPayByState']->value['reminder_state_name'];?>
</td>
    			<td><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['sumToPayByState']->value['sum_paid']),$_smarty_tpl);?>
</td>
    		</tr>
    	<?php } ?>
    	</table>
    ...
    <div class="row">
      <div class="col-md-2">
          <label><?php echo smartyTranslate(array('s'=>'Payment type','mod'=>'product_list'),$_smarty_tpl);?>
</label>
          <input type="hidden" name="order_invoiceFilter_payment_type[]" value="">
          <?php echo smarty_function_html_options(array('multiple'=>"multiple",'name'=>'order_invoiceFilter_payment_type[]','options'=>$_smarty_tpl->tpl_vars['invoice_payment_type_options']->value,'selected'=>$_smarty_tpl->tpl_vars['invoice_payment_type_selected']->value),$_smarty_tpl);?>
...
px"<?php }?> <?php if (isset($_smarty_tpl->tpl_vars['params']->value['id'])) {?> id="<?php echo $_smarty_tpl->tpl_vars['params']->value['id'];?>
"<?php }?> >
