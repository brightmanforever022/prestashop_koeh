<?php /* Smarty version Smarty-3.1.19, created on 2019-08-18 16:40:34
         compiled from "/home/koehlert/public_html/themes/leo_wedding_dress/modules/blocklayered/blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10746867685d596362f3f2f8-59314343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adc41cb49ade08b1319b7ee470135c24604f8f14' => 
    array (
      0 => '/home/koehlert/public_html/themes/leo_wedding_dress/modules/blocklayered/blocklayered.tpl',
      1 => 1563422236,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10746867685d596362f3f2f8-59314343',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5963631e5ac7_99093489',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5963631e5ac7_99093489')) {function content_5d5963631e5ac7_99093489($_smarty_tpl) {?>
<!-- Block layered navigation module -->
<?php if ($_smarty_tpl->tpl_vars['nbr_filterBlocks']->value!=0) {?>
<div id="layered_block_left" class="block">
	<h4 class="title_block"><?php echo smartyTranslate(array('s'=>'Filters','mod'=>'blocklayered'),$_smarty_tpl);?>
</h4>
	<div class="block_content">
		<form action="#" id="layered_form">
			<div>
			<?php if (isset($_smarty_tpl->tpl_vars['selected_filters']->value)&&$_smarty_tpl->tpl_vars['n_filters']->value>0) {?>
			    <a href="#rs" class="blResetLink"><i class="fa fa-trash-o"></i> <?php echo smartyTranslate(array('s'=>'reset filters','mod'=>'blocklayered'),$_smarty_tpl);?>
</a>
			<?php }?>
...
" style="display: none;">
                        ...
                        <div class="layered_subtitle_heading">
                            <span class="layered_subtitle"><?php echo $_smarty_tpl->tpl_vars['filter']->value['name'];?>
</span>
...
?>
										...
										<li class="nomargin <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fe']['index']>=$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']) {?>hiddable<?php }?> col-lg-12">
										    <?php if ($_smarty_tpl->tpl_vars['filter']->value['type']=='cat_colors') {?>
										        <button class="color-option <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])&&$_smarty_tpl->tpl_vars['value']->value['checked']) {?>on<?php }?> 
                                                    <?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?>disable<?php }?>" type="button" name="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type_lite'];?>
...
<?php }?><?php } else { ?>#CCC<?php }?>; color:<?php if (isset($_smarty_tpl->tpl_vars['value']->value['color'])) {?><?php if (file_exists((@constant('_PS_ROOT_DIR_')).("/img/co/".((string)$_smarty_tpl->tpl_vars['id_value']->value).".jpg"))) {?><?php } else { ?><?php echo $_smarty_tpl->tpl_vars['value']->value['color'];?>
...
" /><?php }?>
											<?php } elseif (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?>
...
<?php }?>"<?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])) {?> checked="checked"<?php }?><?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?> disabled="disabled"<?php }?> autocomplete="off" /> 
											<?php }?>
...
"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
												...
												<?php }?>
                                                                                        ...
                                                                                        <?php if ($_smarty_tpl->tpl_vars['filter']->value['type_lite']=='quantity') {?>
                                                                                            <div <?php if (empty($_smarty_tpl->tpl_vars['value']->value['checked'])) {?>style="display:none"<?php }?> id="blInstockFilterText"><b><?php echo smartyTranslate(array('s'=>'Achtung:','mod'=>'blocklayered'),$_smarty_tpl);?>
</b> <?php echo smartyTranslate(array('s'=>'Orderware wird nicht angezeigt.','mod'=>'blocklayered'),$_smarty_tpl);?>
</div>
                                                                                        <?php }?>
										</li>
										<?php }?>
...
"/>
			...
			<input type="hidden" name="search_query" value="<?php echo $_smarty_tpl->tpl_vars['searchQuery']->value;?>
" />
			<?php } else { ?>
			<input type="hidden" name="id_category_layered" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_category_layered']->value);?>
" />
			<?php }?>
			<?php  $_smarty_tpl->tpl_vars['filter'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['filter']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['filters']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
