<?php /* Smarty version Smarty-3.1.19, created on 2019-08-18 16:28:27
         compiled from "/home/koehlert/public_html/themes/leo_wedding_dress/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10184339745d59608ba125e5-06725803%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'faba545447155b4554029961e0e7be39a8bdd631' => 
    array (
      0 => '/home/koehlert/public_html/themes/leo_wedding_dress/authentication.tpl',
      1 => 1549447283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10184339745d59608ba125e5-06725803',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d59608be343f5_53542396',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d59608be343f5_53542396')) {function content_5d59608be343f5_53542396($_smarty_tpl) {?>
...
<h1 class="page-heading hidden"><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)) {?><?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
<?php }?></h1>
<?php if (isset($_smarty_tpl->tpl_vars['back']->value)&&preg_match("/^http/",$_smarty_tpl->tpl_vars['back']->value)) {?><?php if (isset($_smarty_tpl->tpl_vars['current_step'])) {$_smarty_tpl->tpl_vars['current_step'] = clone $_smarty_tpl->tpl_vars['current_step'];
$_smarty_tpl->tpl_vars['current_step']->value = 'login'; $_smarty_tpl->tpl_vars['current_step']->nocache = null; $_smarty_tpl->tpl_vars['current_step']->scope = 0;
} else $_smarty_tpl->tpl_vars['current_step'] = new Smarty_variable('login', null, 0);?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./order-steps.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./errors.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

<?php if (isset($_smarty_tpl->tpl_vars['stateExist'])) {$_smarty_tpl->tpl_vars['stateExist'] = clone $_smarty_tpl->tpl_vars['stateExist'];
$_smarty_tpl->tpl_vars['stateExist']->value = false; $_smarty_tpl->tpl_vars['stateExist']->nocache = null; $_smarty_tpl->tpl_vars['stateExist']->scope = 0;
} else $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(false, null, 0);?>
<?php if (isset($_smarty_tpl->tpl_vars["postCodeExist"])) {$_smarty_tpl->tpl_vars["postCodeExist"] = clone $_smarty_tpl->tpl_vars["postCodeExist"];
$_smarty_tpl->tpl_vars["postCodeExist"]->value = false; $_smarty_tpl->tpl_vars["postCodeExist"]->nocache = null; $_smarty_tpl->tpl_vars["postCodeExist"]->scope = 0;
} else $_smarty_tpl->tpl_vars["postCodeExist"] = new Smarty_variable(false, null, 0);?>
<?php if (isset($_smarty_tpl->tpl_vars["dniExist"])) {$_smarty_tpl->tpl_vars["dniExist"] = clone $_smarty_tpl->tpl_vars["dniExist"];
$_smarty_tpl->tpl_vars["dniExist"]->value = false; $_smarty_tpl->tpl_vars["dniExist"]->nocache = null; $_smarty_tpl->tpl_vars["dniExist"]->scope = 0;
} else $_smarty_tpl->tpl_vars["dniExist"] = new Smarty_variable(false, null, 0);?>
...
?>
	...
	<div class="" style="margin-top:25px;">
		<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'MyTextBlock2'),$_smarty_tpl);?>
...
" method="post" id="new_account_form" class="std clearfix form-horizontal">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h1 class="page-subheading bottom-indent" style="font-size:26px;"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h1>
...
<?php }?>" />
							...
							<?php if (isset($_smarty_tpl->tpl_vars['dniExist'])) {$_smarty_tpl->tpl_vars['dniExist'] = clone $_smarty_tpl->tpl_vars['dniExist'];
$_smarty_tpl->tpl_vars['dniExist']->value = true; $_smarty_tpl->tpl_vars['dniExist']->nocache = null; $_smarty_tpl->tpl_vars['dniExist']->scope = 0;
} else $_smarty_tpl->tpl_vars['dniExist'] = new Smarty_variable(true, null, 0);?>
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="postcode") {?>
							<?php if (isset($_smarty_tpl->tpl_vars['postCodeExist'])) {$_smarty_tpl->tpl_vars['postCodeExist'] = clone $_smarty_tpl->tpl_vars['postCodeExist'];
$_smarty_tpl->tpl_vars['postCodeExist']->value = true; $_smarty_tpl->tpl_vars['postCodeExist']->nocache = null; $_smarty_tpl->tpl_vars['postCodeExist']->scope = 0;
} else $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(true, null, 0);?>
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="State:name") {?>
							<?php if (isset($_smarty_tpl->tpl_vars['stateExist'])) {$_smarty_tpl->tpl_vars['stateExist'] = clone $_smarty_tpl->tpl_vars['stateExist'];
$_smarty_tpl->tpl_vars['stateExist']->value = true; $_smarty_tpl->tpl_vars['stateExist']->nocache = null; $_smarty_tpl->tpl_vars['stateExist']->scope = 0;
} else $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(true, null, 0);?>
...
?>
	...
	<?php }?>-->
    <div class="col-xs-12 ">
       <h1 class="page-subheading" style="font-size:26px;"><?php echo smartyTranslate(array('s'=>'Neukundenregistrierung'),$_smarty_tpl);?>
</h1>

        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'MyTextBlockHook'),$_smarty_tpl);?>
...
" <?php if (isset($_POST['id_gender'])&&$_POST['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id) {?>checked="checked"<?php }?> />
            ...
            <div class="required form-group" >
    					<label class="control-label col-sm-12" for=""><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
 <sup>*</sup></label>
    					<div class="col-sm-12" >
    						<input type="text" class="form-control" id="company" name="company" value="<?php if (isset($_POST['company'])) {?><?php echo $_POST['company'];?>
<?php }?>" />
			...
			<div class="form-group">
				<label class="control-label col-sm-12" for="siret"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
</label>
				<div class="col-sm-12">
...
<?php }?>" />
			...
			<div class="required form-group">
				<label class="control-label col-sm-12" for="customer_firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-12">
...
<?php }?>" />
			...
			<div class="required form-group">
				<label class="control-label col-sm-12" for="customer_lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-12">
...
<?php }?>" />
			...
			<div class="required form-group hidden">
				<label class="control-label col-sm-12" for="email"><?php echo smartyTranslate(array('s'=>'Email'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-12">
				<input type="email" autocomplete="off" class="is_required validate form-control" data-validate="isEmail" id="email" name="email" value="<?php if (isset($_POST['email'])) {?><?php echo $_POST['email'];?>
<?php }?>" />
				</div>
			</div>
			<div class="required password form-group">
				<label class="control-label col-sm-12" for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-12">
            ...
            <div class="required password_conf form-group">
				<label class="control-label col-sm-12" for="passwd_conf"><?php echo smartyTranslate(array('s'=>'password confirm'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-12">
            ...
            <div class="form-group">
					<label class="control-label col-sm-12" for="phone"><?php echo smartyTranslate(array('s'=>'Home phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?> <sup>*</sup><?php }?></label>
					<div class="col-sm-12">
...
<?php }?>" />
            ...
            <div class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>form-group">
    					<label class="control-label col-sm-12" for="phone_mobile"><?php echo smartyTranslate(array('s'=>'Fax'),$_smarty_tpl);?>
...
<?php }?>" />
            ...
            <div class="form-group">
					<label class="control-label col-sm-12" for="phone_mobile_2"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
</label>
					<div class="col-sm-12">
						<input type="text" class="form-control" name="phone_mobile_2" id="phone_mobile_2" value="<?php if (isset($_POST['phone_mobile_2'])) {?><?php echo $_POST['phone_mobile_2'];?>
<?php }?>" />
					</div>
			</div>

                <div class="form-group">
    					<label class="control-label col-sm-12" for="website"><?php echo smartyTranslate(array('s'=>'Website'),$_smarty_tpl);?>
</label>
    					<div class="col-sm-12">
...
<?php }?>" />
		...
		<?php if (isset($_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value)&&$_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value) {?>
			<div class="account_creation" style="margin-bottom:10px;">
				<h2 class="page-subheading" style="font-size:22px;"><?php echo smartyTranslate(array('s'=>'Ladengeschäft'),$_smarty_tpl);?>
</h2>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="firstname") {?>
						<div class="required form-group hidden">
							<label class="control-label col-sm-12" for="firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-12">
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="lastname") {?>
						<div class="required form-group hidden">
							<label class="control-label col-sm-12" for="lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-12">
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address1") {?>
						<div class="required form-group" style="width:100%;">
							<label class="control-label col-sm-12" for="address1"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address2") {?>
						<div class="form-group is_customer_param hidden">
							<label class="control-label col-sm-12 hidden" for="address2"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
...
$_smarty_tpl->tpl_vars['postCodeExist']->value = true; $_smarty_tpl->tpl_vars['postCodeExist']->nocache = null; $_smarty_tpl->tpl_vars['postCodeExist']->scope = 0;
						...
						<div class="required postcode form-group">
							<label class="control-label col-sm-12" for="postcode"><?php echo smartyTranslate(array('s'=>'Zip / Postal Code'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-12">
							<input type="text" class="validate form-control" name="postcode" id="postcode" data-validate="isPostCode" value="<?php if (isset($_POST['postcode'])) {?><?php echo $_POST['postcode'];?>
<?php }?>"/>
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="city") {?>
						<div class="required form-group">
							<label class="control-label col-sm-12" for="city"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-12">
								<input type="text" class="form-control" name="city" id="city" value="<?php if (isset($_POST['city'])) {?><?php echo $_POST['city'];?>
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="Country:name"||$_smarty_tpl->tpl_vars['field_name']->value=="country") {?>
						<div class="required select form-group" style="width:100%;">
							<label class="control-label col-sm-12" for="id_country"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6" style="width:48%;">
...
$_smarty_tpl->tpl_vars['stateExist']->value = true; $_smarty_tpl->tpl_vars['stateExist']->nocache = null; $_smarty_tpl->tpl_vars['stateExist']->scope = 0;
						...
						<div class="required id_state select form-group">
							<label class="control-label col-sm-12" for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-12">
...
<?php }?>"/>
 ...
 <sup>*</sup></label>
				...
				<div class="textarea form-group hidden" style="display:none;">
					<label class="control-label col-sm-12" for="other"><?php echo smartyTranslate(array('s'=>'Additional information'),$_smarty_tpl);?>
</label>
					<div class="col-sm-12">
...
<?php }?></textarea>
				...
				<div class="form-group required ">
    					<label class="control-label col-sm-12" for="reference_brand"><?php echo smartyTranslate(array('s'=>'Referenz Marken '),$_smarty_tpl);?>
<sup>*</sup></label>
    					<div class="col-sm-12">
    						<input type="text" class="form-control" id="reference_brand" name="reference_brand" value="<?php if (isset($_POST['reference_brand'])) {?><?php echo $_POST['reference_brand'];?>
<?php }?>" />
    					</div>
				</div>
                <div class="form-group">
    					<label class="control-label col-sm-12" for="sitze-shop"><?php echo smartyTranslate(array('s'=>'VerkaufsflÃ¤che Ihres LadengeschÃ¤fts '),$_smarty_tpl);?>
<sup>*</sup></label>
    					<div class="col-sm-12">
    						<input type="text" class="form-control" id="sitze-shop" name="size_shop" value="<?php if (isset($_POST['size_shop'])) {?><?php echo $_POST['size_shop'];?>
<?php }?>" />
    					</div>
				</div>
                <?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>
					<?php if (isset($_smarty_tpl->tpl_vars["atLeastOneExists"])) {$_smarty_tpl->tpl_vars["atLeastOneExists"] = clone $_smarty_tpl->tpl_vars["atLeastOneExists"];
$_smarty_tpl->tpl_vars["atLeastOneExists"]->value = true; $_smarty_tpl->tpl_vars["atLeastOneExists"]->nocache = null; $_smarty_tpl->tpl_vars["atLeastOneExists"]->scope = 0;
} else $_smarty_tpl->tpl_vars["atLeastOneExists"] = new Smarty_variable(true, null, 0);?>
				...
				<div class="required form-group" id="address_alias hidden" style="display:none;">
					<label class="control-label col-sm-12" for="alias"><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-12">
...
<?php }?>" />
			...
			<div class="account_creation dni">
				...
				<div class="required form-group">
					<label class="control-label col-sm-12" for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-12">
...
<?php }?>" />
		...
		<?php }?>
        <p><?php echo smartyTranslate(array('s'=>'Mit Ihrer Registrierung bestÃ¤tigen Sie, dass Sie im B2B-Shop ausschliesslich fÃ¼r den Wiederverkauf und nicht fÃ¼r den Eigenbedarf kaufen werden.'),$_smarty_tpl);?>
</p>
		<?php echo $_smarty_tpl->tpl_vars['HOOK_CREATE_ACCOUNT_FORM']->value;?>
