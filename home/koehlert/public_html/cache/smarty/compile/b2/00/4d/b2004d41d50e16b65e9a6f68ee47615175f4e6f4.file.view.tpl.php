<?php /* Smarty version Smarty-3.1.19, created on 2019-08-19 11:16:48
         compiled from "/home/koehlert/public_html/admin971jqkmvw/themes/default/template/controllers/customers/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19378647275d5a6900c35be5-42673414%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b2004d41d50e16b65e9a6f68ee47615175f4e6f4' => 
    array (
      0 => '/home/koehlert/public_html/admin971jqkmvw/themes/default/template/controllers/customers/helpers/view/view.tpl',
      1 => 1558441823,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19378647275d5a6900c35be5-42673414',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5a6900ee25c5_21613366',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5a6900ee25c5_21613366')) {function content_5d5a6900ee25c5_21613366($_smarty_tpl) {?>

<div class="leadin"></div>


<script>
var id_customer = <?php echo $_smarty_tpl->tpl_vars['customer']->value->id;?>
;
</script>
...
<?php }?></p>
					...
					<div class="row">
						<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Credit limit'),$_smarty_tpl);?>
</label>
						<div class="col-lg-9">
							<p class="form-control-static">
...
" />
 ...
 <span class="badge"><?php echo count($_smarty_tpl->tpl_vars['orders']->value);?>
				...
				<?php if ($_smarty_tpl->tpl_vars['orders']->value&&count($_smarty_tpl->tpl_vars['orders']->value)) {?>
					<?php if (isset($_smarty_tpl->tpl_vars['count_ok'])) {$_smarty_tpl->tpl_vars['count_ok'] = clone $_smarty_tpl->tpl_vars['count_ok'];
$_smarty_tpl->tpl_vars['count_ok']->value = count($_smarty_tpl->tpl_vars['orders_ok']->value); $_smarty_tpl->tpl_vars['count_ok']->nocache = null; $_smarty_tpl->tpl_vars['count_ok']->scope = 0;
} else $_smarty_tpl->tpl_vars['count_ok'] = new Smarty_variable(count($_smarty_tpl->tpl_vars['orders_ok']->value), null, 0);?>
					<?php if (isset($_smarty_tpl->tpl_vars['count_ko'])) {$_smarty_tpl->tpl_vars['count_ko'] = clone $_smarty_tpl->tpl_vars['count_ko'];
$_smarty_tpl->tpl_vars['count_ko']->value = count($_smarty_tpl->tpl_vars['orders_ko']->value); $_smarty_tpl->tpl_vars['count_ko']->nocache = null; $_smarty_tpl->tpl_vars['count_ko']->scope = 0;
} else $_smarty_tpl->tpl_vars['count_ko'] = new Smarty_variable(count($_smarty_tpl->tpl_vars['orders_ko']->value), null, 0);?>
					<div class="panel">
						<div class="row">
							<div class="col-lg-6">
...
">
            ...
            <?php if ($_smarty_tpl->tpl_vars['products_groups']->value&&count($_smarty_tpl->tpl_vars['products_groups']->value)) {?>
            <div class="panel">
              <div class="panel-heading">
              ...
              <table class="table">
                <thead>
                  <tr>
                    <th><span class="title_box "><?php echo smartyTranslate(array('s'=>'Photo'),$_smarty_tpl);?>
</span></th>
                    <th><span class="title_box "><?php echo smartyTranslate(array('s'=>'Sup. reference'),$_smarty_tpl);?>
</span></th>
                    <th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Date'),$_smarty_tpl);?>
</span></th>
 ...
 $_from = $_smarty_tpl->tpl_vars['products_groups']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                  <tr >
                    <td><img src="<?php echo $_smarty_tpl->tpl_vars['product_group']->value['image_url'];?>
"></td>
                    <td><?php echo $_smarty_tpl->tpl_vars['product_group']->value['supplier_reference_base'];?>
</td> 
                    <td>--</td>
                    <td>
                      --
                    ...
                    <td>
                      <?php echo $_smarty_tpl->tpl_vars['product_group']->value['quantity_total'];?>

                      <button class="btn btn-default" onclick="$(this).parents('table').find('.product-group-<?php echo $_smarty_tpl->tpl_vars['product_group']->value['product_id'];?>
').show();"
 ...
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['product_group']->value['products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['product']->key => $_smarty_tpl->tpl_vars['product']->value) {
$_smarty_tpl->tpl_vars['product']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['product']->key;
?>
                  <tr class="product-group-<?php echo $_smarty_tpl->tpl_vars['product_group']->value['product_id'];?>
" hidden onclick="document.location = '?tab=AdminOrders&amp;id_order=<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_order']);?>
&amp;vieworder&amp;token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0][0]->getAdminTokenLiteSmarty(array('tab'=>'AdminOrders'),$_smarty_tpl);?>
'">
                    <td><img src="<?php echo $_smarty_tpl->tpl_vars['product']->value['image_url'];?>
"></td>
...
'">
							<td><?php echo $_smarty_tpl->tpl_vars['p']->value['id'];?>
                                                        ...
                                                        <td><img src="<?php echo $_smarty_tpl->tpl_vars['p']->value['image_url'];?>
"></td>
                                                        <td><?php echo $_smarty_tpl->tpl_vars['p']->value['product_supplier_reference'];?>
</td>
