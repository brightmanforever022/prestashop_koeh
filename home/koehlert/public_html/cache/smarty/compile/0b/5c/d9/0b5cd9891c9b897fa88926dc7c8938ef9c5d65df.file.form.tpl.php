<?php /* Smarty version Smarty-3.1.19, created on 2019-08-23 18:38:18
         compiled from "/home/koehlert/public_html/modules/tacartreminder/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9124950725d60167a8498f2-16846753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b5cd9891c9b897fa88926dc7c8938ef9c5d65df' => 
    array (
      0 => '/home/koehlert/public_html/modules/tacartreminder/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1521714356,
      2 => 'file',
    ),
    'c0c9466c6b87569321d17c0fe4ce550c892133d1' => 
    array (
      0 => '/home/koehlert/public_html/admin971jqkmvw/themes/default/template/helpers/form/form.tpl',
      1 => 1560853273,
      2 => 'file',
    ),
    'e05c02886a42279755b2720d25aca772038a45be' => 
    array (
      0 => '/home/koehlert/public_html/admin971jqkmvw/themes/default/template/helpers/form/form_group.tpl',
      1 => 1440056612,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9124950725d60167a8498f2-16846753',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d60167b050967_38904029',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d60167b050967_38904029')) {function content_5d60167b050967_38904029($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/koehlert/public_html/tools/smarty/plugins/function.counter.php';
?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='discountselect') {?>
			<div class="col-lg-9" id="block_select_discount" style="border-left:1px #cecece dashed;padding-left:10px">
				<div class="row form-group">
					<input type="hidden" id="id_cart_rule" name="id_cart_rule" value="<?php echo intval($_smarty_tpl->tpl_vars['fields_value']->value['id_cart_rule']);?>
">
					<label class="control-label col-lg-2">
					 <?php echo smartyTranslate(array('s'=>'Cart rule','mod'=>'tacartreminder'),$_smarty_tpl);?>

					</label>
					<div class="input-group col-lg-7">
							<span class="input-group-addon"><i class="flaticon-search103"></i></span>
							<input type="text" id="cart_rule_filter" name="cart_rule_filter" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value['cart_rule_filter'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
					</div>
				</div>
				<div class="row form-group" >
					<label class="control-label col-lg-2"><?php echo smartyTranslate(array('s'=>'Nb day validity','mod'=>'tacartreminder'),$_smarty_tpl);?>
</label>
					<div class="col-lg-10">
						<div class="input-group col-lg-6">
							<span class="input-group-addon"><?php echo smartyTranslate(array('s'=>'Days','mod'=>'tacartreminder'),$_smarty_tpl);?>
</span>
							<input type="text" id="cart_rule_nbday_validity" class="fixed-width-xs" name="cart_rule_nbday_validity" value="<?php echo intval($_smarty_tpl->tpl_vars['fields_value']->value['cart_rule_nbday_validity']);?>
">
						</div>
					</div>
				</div>
				<div class="row form-group" >
					...
					<div class="col-lg-10">
						<span class="help-block"><i class="flaticon-info2"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'This action will duplicate the voucher and associate it to the customer','mod'=>'tacartreminder'),$_smarty_tpl);?>
</span>
					</div>
				</div>
			</div>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='datetime'&&$_smarty_tpl->tpl_vars['ps_version']->value<"1.6") {?>
			<div class="form-group row">
				<label for="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="control-label col-lg-3 ">
				<?php if ($_smarty_tpl->tpl_vars['input']->value['name']=='date_from') {?>
					<?php echo smartyTranslate(array('s'=>'From','mod'=>'tacartreminder'),$_smarty_tpl);?>

				<?php } else { ?>
					<?php echo smartyTranslate(array('s'=>'To','mod'=>'tacartreminder'),$_smarty_tpl);?>
...
" type="text" data-hex="true" class="datetimepicker" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true);?>
">
...
').datetimepicker({
					...
					currentText: '<?php echo smartyTranslate(array('s'=>'Now','mod'=>'tacartreminder'),$_smarty_tpl);?>
',
					closeText: '<?php echo smartyTranslate(array('s'=>'Done','mod'=>'tacartreminder'),$_smarty_tpl);?>
',
					ampm: false,
					amNames: ['AM', 'A'],
					pmNames: ['PM', 'P'],
					...
					timeSuffix: '',
					timeOnlyTitle: '<?php echo smartyTranslate(array('s'=>'Choose Time','mod'=>'tacartreminder'),$_smarty_tpl);?>
',
					timeText: '<?php echo smartyTranslate(array('s'=>'Time','mod'=>'tacartreminder'),$_smarty_tpl);?>
',
					hourText: '<?php echo smartyTranslate(array('s'=>'Hour','mod'=>'tacartreminder'),$_smarty_tpl);?>
',
					minuteText: '<?php echo smartyTranslate(array('s'=>'Minute','mod'=>'tacartreminder'),$_smarty_tpl);?>
',
				});
			});
			</script>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='condition') {?>
			<script type="text/javascript">
				var condition_groups_counter = <?php if (isset($_smarty_tpl->tpl_vars['condition_groups_counter']->value)) {?><?php echo intval($_smarty_tpl->tpl_vars['condition_groups_counter']->value);?>
<?php } else { ?>0<?php }?>;
				var condition_counters = new Array();
			</script>
			<div class="col-lg-12">
					<div class="row">
						<h4><?php echo smartyTranslate(array('s'=>'The cart must validate the following rules:','mod'=>'tacartreminder'),$_smarty_tpl);?>
</h4>
					</div>
					<div class="row">
 ...
 $_from = $_smarty_tpl->tpl_vars['condition_groups']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
									<?php echo $_smarty_tpl->tpl_vars['condition_group']->value;?>

								<?php } ?>
							</table>
							<a href="javascript:addConditionGroup();" class="btn btn-default ">
								<i class="flaticon-add11"></i> <?php echo smartyTranslate(array('s'=>'New condition group','mod'=>'tacartreminder'),$_smarty_tpl);?>

							</a>
						</div>
					</div>
				</div>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='reminder') {?>
			<script type="text/javascript">
				var reminders_counter = <?php if (isset($_smarty_tpl->tpl_vars['reminders_counter']->value)) {?><?php echo intval($_smarty_tpl->tpl_vars['reminders_counter']->value);?>
<?php } else { ?>0<?php }?>;
			</script>
			<div class="col-lg-12">
					<div class="row">
						<div id="reminder_div">
							<table id="reminder_table" class="table">
								<?php  $_smarty_tpl->tpl_vars['reminder'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['reminder']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['reminders']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['reminder']->key => $_smarty_tpl->tpl_vars['reminder']->value) {
$_smarty_tpl->tpl_vars['reminder']->_loop = true;
?>
									<?php echo $_smarty_tpl->tpl_vars['reminder']->value;?>

								<?php } ?>
							</table>
							<a href="javascript:addReminder();" class="btn btn-default ">
								<i class="flaticon-add11"></i> <?php echo smartyTranslate(array('s'=>'New reminder','mod'=>'tacartreminder'),$_smarty_tpl);?>

							</a>
						</div>
					</div>
			</div>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='force_reminder') {?>
		<div class="form-group">
				<label class="control-label col-lg-3">
					<span class="label-tooltip" data-toggle="tooltip"
					title="<?php echo smartyTranslate(array('s'=>'Perform the following reminder without checking if the cart is subject to conditions.','mod'=>'tacartreminder'),$_smarty_tpl);?>
">
						<?php echo smartyTranslate(array('s'=>'Force launch reminder','mod'=>'tacartreminder'),$_smarty_tpl);?>

					</span>
				</label>
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg" >
						<input type="radio" name="force_reminder" id="force_reminder_on" value="1" <?php if (intval($_smarty_tpl->tpl_vars['fields_value']->value['force_reminder'])) {?> checked="checked"<?php }?>/>
						<label for="force_reminder_on"><?php echo smartyTranslate(array('s'=>'Yes','mod'=>'tacartreminder'),$_smarty_tpl);?>
</label>
						<input type="radio" name="force_reminder" id="force_reminder_off" value="0" <?php if (!intval($_smarty_tpl->tpl_vars['fields_value']->value['force_reminder'])) {?> checked="checked"<?php }?> />
						<label for="force_reminder_off"><?php echo smartyTranslate(array('s'=>'No','mod'=>'tacartreminder'),$_smarty_tpl);?>
</label>
						<a class="slide-button btn"></a>
					</span>
				</div>
		</div>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='textarea'&&$_smarty_tpl->tpl_vars['input']->value['name']=='content_html') {?>
...
<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='datetime'&&$_smarty_tpl->tpl_vars['ps_version']->value<"1.6") {?>
...
"<?php }?>
                                                                                                <?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?> disabled="disabled"<?php }?>
                                                                                                <?php if (isset($_smarty_tpl->tpl_vars['input']->value['autoCompleteOff'])&&$_smarty_tpl->tpl_vars['input']->value['autoCompleteOff']) {?> autocomplete="off"<?php }?>>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '9124950725d60167a8498f2-16846753');
content_5d60167ad2a931_75400965($_smarty_tpl);
...
<br />
	...
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='example_mails') {?>
	
	<div class="form-group">
			<label for="example_mails" class="control-label <?php if ($_smarty_tpl->tpl_vars['ps_version']->value<"1.6") {?><?php } else { ?>col-lg-3<?php }?>">
				<span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="<?php echo smartyTranslate(array('s'=>'Here you can select a sample email and click "copy" to replace the contents','mod'=>'tacartreminder'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Sample emails','mod'=>'tacartreminder'),$_smarty_tpl);?>

				</span>
			</label>
			<div class="col-lg-9">
				<ul id="carousel" class="elastislide-list">
					<?php  $_smarty_tpl->tpl_vars['egmail'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['egmail']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['egmails']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['egmail']->key => $_smarty_tpl->tpl_vars['egmail']->value) {
$_smarty_tpl->tpl_vars['egmail']->_loop = true;
?>
						<li><a href="javascript:;" class="egmail_item" data-egmailid="<?php echo intval($_smarty_tpl->tpl_vars['egmail']->value->id);?>
"><span class="rollover" ></span><img src="<?php echo addslashes($_smarty_tpl->tpl_vars['ta_img_url']->value);?>
/egmail/<?php echo intval($_smarty_tpl->tpl_vars['egmail']->value->id);?>
-cover.jpg" alt="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['egmail']->value->title, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" /></a></li>
					<?php } ?>
				</ul>
			</div>
	...
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='convert_html_to_txt') {?>
	<?php if ($_smarty_tpl->tpl_vars['ps_version']->value<"1.6") {?>
		<div class="margin-form">
			<a href="javascript:;" class="btn btn-default convertHtmlToTxt">
						<i class="flaticon flaticon-wizard"></i> <?php echo smartyTranslate(array('s'=>'Auto convert html -> txt','mod'=>'tacartreminder'),$_smarty_tpl);?>
	...
	<?php }?>	
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='preview_mail') {?>
	<?php if ($_smarty_tpl->tpl_vars['ps_version']->value<"1.6") {?>
		<label>
			<span >
					<?php echo smartyTranslate(array('s'=>'Email preview','mod'=>'tacartreminder'),$_smarty_tpl);?>

			</span>
		</label>
		<div class="margin-form">
			<!--select name="cart_mail_preview" id="cart_mail_preview">
						<?php  $_smarty_tpl->tpl_vars['cart_mail'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['cart_mail']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['cart_mails']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['cart_mail']->key => $_smarty_tpl->tpl_vars['cart_mail']->value) {
$_smarty_tpl->tpl_vars['cart_mail']->_loop = true;
?>
							<option value="<?php echo intval($_smarty_tpl->tpl_vars['cart_mail']->value['id_cart']);?>
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['cart_mail']->value['date_add'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
 <?php echo intval($_smarty_tpl->tpl_vars['cart_mail']->value['id_cart']);?>
 - <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['cart_mail']->value['firstname'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
 <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['cart_mail']->value['lastname'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
 - <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['cart_mail']->value['iso_code'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</option>									
						<?php } ?>
			</select-->
			<a href="javascript:;" class="btn btn-default previewMail" data-type-render="html" style="float:left;" >
						<i class="flaticon flaticon-eye46"></i> <?php echo smartyTranslate(array('s'=>'Preview HTML','mod'=>'tacartreminder'),$_smarty_tpl);?>

			</a>
			<!--a href="javascript:;" class="btn btn-default previewMail" data-type-render="txt" >
						<i class="flaticon flaticon-eye46"></i> <?php echo smartyTranslate(array('s'=>'Preview TXT','mod'=>'tacartreminder'),$_smarty_tpl);?>
...
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['cart_mail']->value['date_add'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
 ...
 - <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['cart_mail']->value['iso_code'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
	...
	<?php }?>
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='crontab') {?>
			<div class="col-lg-12">
					<div class="row"><i class="flaticon flaticon-chronometer10" style="font-size:20px"></i>
						<?php echo smartyTranslate(array('s'=>'The following lines are to be added to crontab :','mod'=>'tacartreminder'),$_smarty_tpl);?>
 <br/>
						<?php echo $_smarty_tpl->tpl_vars['cron_urls']->value;?>
...
<?php if (isset($_smarty_tpl->tpl_vars['name_controller']->value)) {?>
  <?php $_smarty_tpl->_capture_stack[0][] = array('hookName', 'hookName', null); ob_start(); ?>display<?php echo ucfirst($_smarty_tpl->tpl_vars['name_controller']->value);?>
FormAfter<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
...
';
	...
	var tacartreminder_ajax_url = '<?php echo preg_replace("%(?<!\\\\)'%", "\'",$_smarty_tpl->tpl_vars['tacartreminder_ajax_url']->value);?>
';
	var tamodule_url = '<?php echo preg_replace("%(?<!\\\\)'%", "\'",$_smarty_tpl->tpl_vars['module_url']->value);?>
';
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2019-08-23 18:38:18
         compiled from "/home/koehlert/public_html/admin971jqkmvw/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5d60167ad2a931_75400965')) {function content_5d60167ad2a931_75400965($_smarty_tpl) {?>
