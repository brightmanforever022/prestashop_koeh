<?php /* Smarty version Smarty-3.1.19, created on 2019-08-19 08:41:51
         compiled from "/home/koehlert/public_html/themes/leo_wedding_dress/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18174941695d5a44af72e829-92194104%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ed7db88a60493c2a312252e2cf614e72699f20b' => 
    array (
      0 => '/home/koehlert/public_html/themes/leo_wedding_dress/order-detail.tpl',
      1 => 1527265982,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18174941695d5a44af72e829-92194104',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5a44afa368b4_11835257',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5a44afa368b4_11835257')) {function content_5d5a44afa368b4_11835257($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/koehlert/public_html/tools/smarty/plugins/modifier.replace.php';
...
" name="id_order"/>
	...
	<?php }?>
	<p class="dark">
		<strong><?php echo smartyTranslate(array('s'=>'Order ID %s - placed on','sprintf'=>$_smarty_tpl->tpl_vars['order']->value->id),$_smarty_tpl);?>
...
<?php if (count($_smarty_tpl->tpl_vars['order_invoices']->value)) {?>
<div>
	<h1 class="page-heading"><?php echo smartyTranslate(array('s'=>'Order invoices'),$_smarty_tpl);?>
</h1>
	<div class="table_block table-responsive">
		...
		<thead>
			<tr>
				...
				<th class=""><?php echo smartyTranslate(array('s'=>'Amount'),$_smarty_tpl);?>
</th>
				<th class=""><?php echo smartyTranslate(array('s'=>'Payment status'),$_smarty_tpl);?>
</th>
				<th class="last_item"><?php echo smartyTranslate(array('s'=>'Invoice number'),$_smarty_tpl);?>
</th>
			</tr>
		</thead>
		<tbody>
		<?php  $_smarty_tpl->tpl_vars['invoice'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['invoice']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['order_invoices']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
			<tr class="">
				<td class=""><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0][0]->dateFormat(array('date'=>$_smarty_tpl->tpl_vars['invoice']->value['date_add'],'full'=>0),$_smarty_tpl);?>
</td>
				<td><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['invoice']->value['sum_to_pay'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
</td>
				<td>
					<?php if ($_smarty_tpl->tpl_vars['invoice']->value['paid']) {?><?php echo smartyTranslate(array('s'=>'Paid'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Not paid'),$_smarty_tpl);?>
<?php }?>
				</td>
				<td><a href="<?php echo $_smarty_tpl->tpl_vars['invoice']->value['invoice_pdf_link'];?>
"><?php echo $_smarty_tpl->tpl_vars['invoice']->value['number_formatted'];?>
</a></td>
			</tr>
		<?php } ?>
		</tbody>
...
?>
					...
					<?php } else { ?>
							<?php if (isset($_smarty_tpl->tpl_vars['address_words'])) {$_smarty_tpl->tpl_vars['address_words'] = clone $_smarty_tpl->tpl_vars['address_words'];
$_smarty_tpl->tpl_vars['address_words']->value = explode(" ",$_smarty_tpl->tpl_vars['field_item']->value); $_smarty_tpl->tpl_vars['address_words']->nocache = null; $_smarty_tpl->tpl_vars['address_words']->scope = 0;
} else $_smarty_tpl->tpl_vars['address_words'] = new Smarty_variable(explode(" ",$_smarty_tpl->tpl_vars['field_item']->value), null, 0);?>
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th class="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>item<?php } else { ?>first_item<?php }?>"><?php echo smartyTranslate(array('s'=>'Image'),$_smarty_tpl);?>
</th>
				<th class="item"><?php echo smartyTranslate(array('s'=>'Product'),$_smarty_tpl);?>
</th>
				<th class="item"><?php echo smartyTranslate(array('s'=>'Shipped'),$_smarty_tpl);?>
</th>
		...
		<tfoot>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value&&$_smarty_tpl->tpl_vars['use_tax']->value) {?>
				<tr class="item">
					...
					<td colspan="<?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()) {?>6<?php } else { ?>5<?php }?>">
...
$_smarty_tpl->tpl_vars['productId']->value = $_smarty_tpl->tpl_vars['product']->value['product_id']; $_smarty_tpl->tpl_vars['productId']->nocache = null; $_smarty_tpl->tpl_vars['productId']->scope = 0;
} else $_smarty_tpl->tpl_vars['productId'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['product_id'], null, 0);?>
...
$_smarty_tpl->tpl_vars['productAttributeId']->value = $_smarty_tpl->tpl_vars['product']->value['product_attribute_id']; $_smarty_tpl->tpl_vars['productAttributeId']->nocache = null; $_smarty_tpl->tpl_vars['productAttributeId']->scope = 0;
} else $_smarty_tpl->tpl_vars['productAttributeId'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['product_attribute_id'], null, 0);?>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['product']->value['customizedDatas'])) {?>
					<tr class="item">
						...
						<td>
							...
							<a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value['product_id']);?>
">
							<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['image']->id,'small_default'), ENT_QUOTES, 'UTF-8', true);?>
" />
							</a>
						</td>
						<td class="bold">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
						...
						<td><?php if ($_smarty_tpl->tpl_vars['product']->value['shipped']=='1') {?><?php echo smartyTranslate(array('s'=>'Yes'),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['data']->_loop = true;
?>
										<?php if (isset($_smarty_tpl->tpl_vars['customizationFieldName'])) {$_smarty_tpl->tpl_vars['customizationFieldName'] = clone $_smarty_tpl->tpl_vars['customizationFieldName'];
$_smarty_tpl->tpl_vars['customizationFieldName']->value = ("Text #").($_smarty_tpl->tpl_vars['data']->value['id_customization_field']); $_smarty_tpl->tpl_vars['customizationFieldName']->nocache = null; $_smarty_tpl->tpl_vars['customizationFieldName']->scope = 0;
} else $_smarty_tpl->tpl_vars['customizationFieldName'] = new Smarty_variable(("Text #").($_smarty_tpl->tpl_vars['data']->value['id_customization_field']), null, 0);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['carriers'])) {$_smarty_tpl->tpl_vars['carriers'] = clone $_smarty_tpl->tpl_vars['carriers'];
$_smarty_tpl->tpl_vars['carriers']->value = $_smarty_tpl->tpl_vars['order']->value->getShipping(); $_smarty_tpl->tpl_vars['carriers']->nocache = null; $_smarty_tpl->tpl_vars['carriers']->scope = 0;
} else $_smarty_tpl->tpl_vars['carriers'] = new Smarty_variable($_smarty_tpl->tpl_vars['order']->value->getShipping(), null, 0);?>
<?php if (false&&count($_smarty_tpl->tpl_vars['carriers']->value)>0&&isset($_smarty_tpl->tpl_vars['carriers']->value[0]['carrier_name'])&&$_smarty_tpl->tpl_vars['carriers']->value[0]['carrier_name']) {?>
