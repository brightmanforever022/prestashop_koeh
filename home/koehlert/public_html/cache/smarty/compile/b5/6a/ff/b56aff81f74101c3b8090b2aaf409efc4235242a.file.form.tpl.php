<?php /* Smarty version Smarty-3.1.19, created on 2019-08-18 17:03:16
         compiled from "/home/koehlert/public_html/override/controllers/admin/templates/employees/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16222827965d5968b4a28d77-89125083%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b56aff81f74101c3b8090b2aaf409efc4235242a' => 
    array (
      0 => '/home/koehlert/public_html/override/controllers/admin/templates/employees/helpers/form/form.tpl',
      1 => 1562768785,
      2 => 'file',
    ),
    ...
    'ff271e05e1f45ba5687ed008a299b18ec887d887' => 
    array (
      0 => '/home/koehlert/public_html/override/controllers/admin/templates/employees/employee_country_form.tpl',
      1 => 1561651685,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16222827965d5968b4a28d77-89125083',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5968b5182366_58955157',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5968b5182366_58955157')) {function content_5d5968b5182366_58955157($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/koehlert/public_html/tools/smarty/plugins/function.counter.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '16222827965d5968b4a28d77-89125083');
content_5d5968b4efeee9_40839624($_smarty_tpl);
...
<div class="panel" id="employeeCountriesPanel" style="min-height: 450px;">
  <div class="panel-heading">
    <?php echo smartyTranslate(array('s'=>'Related countries'),$_smarty_tpl);?>

  </div>
  <div class="row">
    <div class="col-lg-12">
      <p class="alert alert-info">
      <?php echo smartyTranslate(array('s'=>'If country not set, employee linked to all countries. If postcodes of country not set, employee linked to entire country'),$_smarty_tpl);?>
  ...
  <div class="row">
    <div class="col-lg-4">
      <h4><?php echo smartyTranslate(array('s'=>'Add/Edit country'),$_smarty_tpl);?>
</h4>
      <button type="button" class="btn btn-primary" id="employeeCountryNew"><?php echo smartyTranslate(array('s'=>'New country'),$_smarty_tpl);?>
</button>
      <div id="employeeCountryFormContainer" hidden>
      <?php /*  Call merged included template "../../employee_country_form.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../../employee_country_form.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '16222827965d5968b4a28d77-89125083');
content_5d5968b5129589_42990945($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "../../employee_country_form.tpl" */?>
      </div>
    </div>
    <div class="col-lg-8" id="">
      <h4><?php echo smartyTranslate(array('s'=>'Related countries'),$_smarty_tpl);?>
</h4>
...
;
var employeeAreaControllerUrl = "<?php echo $_smarty_tpl->tpl_vars['employee_area_controller_url']->value;?>
";
//-->
</script>
<?php }?>
...
<?php if ($_valid && !is_callable('content_5d5968b4efeee9_40839624')) {function content_5d5968b4efeee9_40839624($_smarty_tpl) {?>
...
<?php /* Smarty version Smarty-3.1.19, created on 2019-08-18 17:03:17
         compiled from "/home/koehlert/public_html/override/controllers/admin/templates/employees/employee_country_form.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5d5968b5129589_42990945')) {function content_5d5968b5129589_42990945($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/koehlert/public_html/tools/smarty/plugins/function.html_options.php';
?><form action="" method="post" id="employeeCountryForm">
    <input type="hidden" name="id" value="<?php if (isset($_smarty_tpl->tpl_vars['employee_country']->value['id_employee_country'])) {?><?php echo $_smarty_tpl->tpl_vars['employee_country']->value['id_employee_country'];?>
<?php }?>">
      <label><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
</label>
      <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['countries_options']->value,'name'=>'id_country','selected'=>$_smarty_tpl->tpl_vars['employee_country']->value['id_country']),$_smarty_tpl);?>

      
      <label><?php echo smartyTranslate(array('s'=>'Postcodes'),$_smarty_tpl);?>
</label>
      <textarea rows="5" cols="20" name="postcodes"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['employee_country']->value['postcodes'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
      <p class="text-muted">
      ...
      <button type="button" id="employeeCountrySubmit" class="btn btn-default"
        ><?php echo smartyTranslate(array('s'=>'Save related country'),$_smarty_tpl);?>
</button>
</form><?php }} ?>
