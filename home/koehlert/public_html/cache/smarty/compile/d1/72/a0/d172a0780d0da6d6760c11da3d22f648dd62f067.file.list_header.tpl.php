<?php /* Smarty version Smarty-3.1.19, created on 2019-09-10 14:10:12
         compiled from "/home/koehlert/public_html/admin971jqkmvw/themes/default/template/controllers/orders/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10924521165d59642bb3f446-19605792%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd172a0780d0da6d6760c11da3d22f648dd62f067' => 
    array (
      0 => '/home/koehlert/public_html/admin971jqkmvw/themes/default/template/controllers/orders/helpers/list/list_header.tpl',
      1 => 1559651267,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10924521165d59642bb3f446-19605792',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5d59642be13655_25380828',
  'variables' => 
  array (
    'ajax' => 0,
    'is_order_position' => 0,
...
<?php if ($_valid && !is_callable('content_5d59642be13655_25380828')) {function content_5d59642be13655_25380828($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/koehlert/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_replace')) include '/home/koehlert/public_html/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_html_checkboxes')) include '/home/koehlert/public_html/tools/smarty/plugins/function.html_checkboxes.php';
...
if (!is_callable('smarty_function_html_radios')) include '/home/koehlert/public_html/tools/smarty/plugins/function.html_radios.php';
?>
...
<?php if (!empty($_REQUEST['orders_search'])) {?>
    <?php if (isset($_smarty_tpl->tpl_vars['show_filters'])) {$_smarty_tpl->tpl_vars['show_filters'] = clone $_smarty_tpl->tpl_vars['show_filters'];
$_smarty_tpl->tpl_vars['show_filters']->value = 1; $_smarty_tpl->tpl_vars['show_filters']->nocache = null; $_smarty_tpl->tpl_vars['show_filters']->scope = 0;
} else $_smarty_tpl->tpl_vars['show_filters'] = new Smarty_variable(1, null, 0);?>    
    <?php if (isset($_smarty_tpl->tpl_vars['filters_has_value'])) {$_smarty_tpl->tpl_vars['filters_has_value'] = clone $_smarty_tpl->tpl_vars['filters_has_value'];
$_smarty_tpl->tpl_vars['filters_has_value']->value = 1; $_smarty_tpl->tpl_vars['filters_has_value']->nocache = null; $_smarty_tpl->tpl_vars['filters_has_value']->scope = 0;
} else $_smarty_tpl->tpl_vars['filters_has_value'] = new Smarty_variable(1, null, 0);?>    
<?php }?>
...
MultySelectCont" ></div>
    ...
    <table style="width:100%">
        <tr>
            <td><?php echo smartyTranslate(array('s'=>'Search:'),$_smarty_tpl);?>
&nbsp;&nbsp;</td>
            <td style="width:100%"><input type="text" name="orders_search" value="<?php if (!empty($_REQUEST['orders_search'])) {?><?php echo $_REQUEST['orders_search'];?>
<?php }?>" autocomplete="off" />
                <a href="#" onClick="$('#searchOptions').slideToggle();"><?php echo smartyTranslate(array('s'=>'Search options'),$_smarty_tpl);?>
</a>
            </td>
        </tr>
        <tr id="searchOptions" style="display:none">
              <td colspan="2"><?php echo smartyTranslate(array('s'=>'Search in fileds:'),$_smarty_tpl);?>

                  <input type="hidden" name="scfg[customer_name]" value="0" />
              <input type="checkbox" name="scfg[customer_name]" value="1" <?php if (!isset($_REQUEST['scfg']['customer_name'])||!empty($_REQUEST['scfg']['customer_name'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Customer Name'),$_smarty_tpl);?>
&nbsp;&nbsp;
              <input type="hidden" name="scfg[customer_email]" value="0" />
              <input type="checkbox" name="scfg[customer_email]" value="1" <?php if (!isset($_REQUEST['scfg']['customer_email'])||!empty($_REQUEST['scfg']['customer_email'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Customer Email'),$_smarty_tpl);?>
&nbsp;&nbsp;
              <input type="hidden" name="scfg[customer_address]" value="0" />
              <input type="checkbox" name="scfg[customer_address]" value="1" <?php if (!isset($_REQUEST['scfg']['customer_address'])||!empty($_REQUEST['scfg']['customer_address'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Customer address'),$_smarty_tpl);?>
&nbsp;&nbsp;
              <input type="hidden" name="scfg[customer_phone]" value="0" />
               <input type="checkbox" name="scfg[customer_phone]" value="1" <?php if (!isset($_REQUEST['scfg']['customer_phone'])||!empty($_REQUEST['scfg']['customer_phone'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Customer Phone'),$_smarty_tpl);?>
&nbsp;&nbsp;
               
               <input type="hidden" name="scfg[product_id]" value="0" />
               <input type="checkbox" name="scfg[product_id]" value="1" <?php if (!isset($_REQUEST['scfg']['product_id'])||!empty($_REQUEST['scfg']['product_id'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Product id'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <input type="hidden" name="scfg[supplier_reference]" value="0" />
               <input type="checkbox" name="scfg[supplier_reference]" value="1" <?php if (!isset($_REQUEST['scfg']['supplier_reference'])||!empty($_REQUEST['scfg']['supplier_reference'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Supplier reference'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <input type="hidden" name="scfg[product_name]" value="0" />
               <input type="checkbox" name="scfg[product_name]" value="1" <?php if (!isset($_REQUEST['scfg']['product_name'])||!empty($_REQUEST['scfg']['product_name'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Product name'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <input type="hidden" name="scfg[invoice_id]" value="0" />
               <input type="checkbox" name="scfg[invoice_id]" value="1" <?php if (!isset($_REQUEST['scfg']['invoice_id'])||!empty($_REQUEST['scfg']['invoice_id'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Invoice id'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <input type="hidden" name="scfg[supplier_name]" value="0" />
               <input type="checkbox" name="scfg[supplier_name]" value="1" <?php if (!isset($_REQUEST['scfg']['supplier_name'])||!empty($_REQUEST['scfg']['supplier_name'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Supplier name'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <input type="hidden" name="scfg[country_name]" value="0" />
               <input type="checkbox" name="scfg[country_name]" value="1" <?php if (!isset($_REQUEST['scfg']['country_name'])||!empty($_REQUEST['scfg']['country_name'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Country name'),$_smarty_tpl);?>
&nbsp;&nbsp;
               	<input type="hidden" name="scfg[company_name]" value="0" />
               	<input type="checkbox" name="scfg[company_name]" value="1" <?php if (!isset($_REQUEST['scfg']['company_name'])||!empty($_REQUEST['scfg']['company_name'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>

               	<input type="hidden" name="scfg[notes]" value="0" />
               	<input type="checkbox" name="scfg[notes]" value="1" <?php if (!isset($_REQUEST['scfg']['notes'])||!empty($_REQUEST['scfg']['notes'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Notes'),$_smarty_tpl);?>

               	|
               	<p><?php echo smartyTranslate(array('s'=>'Postcode starts..'),$_smarty_tpl);?>

               	<?php if (isset($_REQUEST['postcode_starts'])) {?>
					<?php if (isset($_smarty_tpl->tpl_vars['postcode_starts_selected'])) {$_smarty_tpl->tpl_vars['postcode_starts_selected'] = clone $_smarty_tpl->tpl_vars['postcode_starts_selected'];
$_smarty_tpl->tpl_vars['postcode_starts_selected']->value = $_REQUEST['postcode_starts']; $_smarty_tpl->tpl_vars['postcode_starts_selected']->nocache = null; $_smarty_tpl->tpl_vars['postcode_starts_selected']->scope = 0;
} else $_smarty_tpl->tpl_vars['postcode_starts_selected'] = new Smarty_variable($_REQUEST['postcode_starts'], null, 0);?>
				<?php } else { ?>
					<?php if (isset($_smarty_tpl->tpl_vars['postcode_starts_selected'])) {$_smarty_tpl->tpl_vars['postcode_starts_selected'] = clone $_smarty_tpl->tpl_vars['postcode_starts_selected'];
$_smarty_tpl->tpl_vars['postcode_starts_selected']->value = array(); $_smarty_tpl->tpl_vars['postcode_starts_selected']->nocache = null; $_smarty_tpl->tpl_vars['postcode_starts_selected']->scope = 0;
} else $_smarty_tpl->tpl_vars['postcode_starts_selected'] = new Smarty_variable(array(), null, 0);?>
				<?php }?>
               	<?php echo smarty_function_html_checkboxes(array('name'=>'postcode_starts','values'=>$_smarty_tpl->tpl_vars['postcode_options']->value,'output'=>$_smarty_tpl->tpl_vars['postcode_options']->value,'selected'=>$_smarty_tpl->tpl_vars['postcode_starts_selected']->value,'separator'=>' &nbsp; '),$_smarty_tpl);?>

               	</p>
               <div class="clearfix">
	               <div style="width:20%;float:left;margin-right:10px">
	               <?php echo smartyTranslate(array('s'=>'Order type'),$_smarty_tpl);?>

	               <?php echo smarty_function_html_options(array('name'=>'id_order_type[]','id'=>'id_order_type','options'=>$_smarty_tpl->tpl_vars['order_types']->value,'selected'=>$_smarty_tpl->tpl_vars['order_type_selected']->value,'multiple'=>'multiple'),$_smarty_tpl);?>

	               </div>
	               <div style="width:20%;float:left;margin-right:10px">
	               <?php echo smartyTranslate(array('s'=>'Order statuses'),$_smarty_tpl);?>

	               <?php echo smarty_function_html_options(array('name'=>'id_order_statuses[]','id'=>'id_order_statuses','options'=>$_smarty_tpl->tpl_vars['order_statuses']->value,'selected'=>$_smarty_tpl->tpl_vars['order_statuses_selected']->value,'multiple'=>'multiple'),$_smarty_tpl);?>

	               </div>
	               <div style="width:20%;float:left;margin-right:10px;">
	               <?php echo smartyTranslate(array('s'=>'Supplier'),$_smarty_tpl);?>

	               <?php echo smarty_function_html_options(array('name'=>'id_supplier[]','id'=>'id_supplier','options'=>$_smarty_tpl->tpl_vars['supplier_filter_options']->value,'selected'=>$_smarty_tpl->tpl_vars['supplier_filter_selected']->value,'multiple'=>'multiple'),$_smarty_tpl);?>
               ...
               <input type="checkbox" name="not_shipped" value="1" <?php if (isset($_REQUEST['not_shipped'])&&!empty($_REQUEST['not_shipped'])) {?>checked="checked"<?php }?> autocomplete="off"> <?php echo smartyTranslate(array('s'=>'Not shipped (Orders that has not shipped products)'),$_smarty_tpl);?>
&nbsp;&nbsp;
               
               <br>
               <input type="checkbox" name="invoice_30_paid" value="1" <?php if (isset($_REQUEST['invoice_30_paid'])&&!empty($_REQUEST['invoice_30_paid'])) {?>checked="checked"<?php }?>> <?php echo smartyTranslate(array('s'=>'30% invoice is paid'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <br>
               <input type="checkbox" name="invoice_prepay_paid" value="1" <?php if (isset($_REQUEST['invoice_prepay_paid'])&&!empty($_REQUEST['invoice_prepay_paid'])) {?>checked="checked"<?php }?>> <?php echo smartyTranslate(array('s'=>'Advanced payment invoice is paid'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <br>

               <input type="checkbox" name="ship_by_invoice" value="1" <?php if (isset($_REQUEST['ship_by_invoice'])&&!empty($_REQUEST['ship_by_invoice'])) {?>checked="checked"<?php }?>> <?php echo smartyTranslate(array('s'=>'Ship by invoice'),$_smarty_tpl);?>
&nbsp;&nbsp;
               <br>
               <input type="checkbox" name="noship_paid30_shipinvoice" value="1" <?php if (isset($_REQUEST['noship_paid30_shipinvoice'])&&!empty($_REQUEST['noship_paid30_shipinvoice'])) {?>checked="checked"<?php }?>> 
               	<?php echo smartyTranslate(array('s'=>'Orders that has not shipped products AND 30% invoice is paid OR customer is Ship by invoice customer OR Advanced payment invoice is paid'),$_smarty_tpl);?>
&nbsp;&nbsp;
                <br>
                <input type="checkbox" name="can_be_shipped_only" value="1" <?php if (isset($_REQUEST['can_be_shipped_only'])&&!empty($_REQUEST['can_be_shipped_only'])) {?>checked="checked"<?php }?>> 
               	<?php echo smartyTranslate(array('s'=>'Show only orders that can be shipped by stock state and shipping priority'),$_smarty_tpl);?>
&nbsp;&nbsp;
				<br>
               	<?php echo smartyTranslate(array('s'=>'Customers that has overdued invoices (marked red)'),$_smarty_tpl);?>
:
				<?php echo smarty_function_html_radios(array('name'=>'overdued_customers','options'=>$_smarty_tpl->tpl_vars['overdued_filter_options']->value,'selected'=>$_smarty_tpl->tpl_vars['overdued_filter_selected']->value,'labels'=>false),$_smarty_tpl);?>
    ...
    <a href="#" onClick="$('#filtersDescription').slideToggle();"><?php echo smartyTranslate(array('s'=>'Filters description'),$_smarty_tpl);?>
</a>  &nbsp;&nbsp;
    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&token=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
&getSmartShippingList"><?php echo smartyTranslate(array('s'=>'Smart shipping list'),$_smarty_tpl);?>
</a> 
    ...
    <ul id="filtersDescription" style="display:none">
    	<li>
    		<strong><?php echo smartyTranslate(array('s'=>'May be shipped'),$_smarty_tpl);?>
</strong>: 
