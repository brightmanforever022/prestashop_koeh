<?php /* Smarty version Smarty-3.1.19, created on 2019-08-18 16:30:04
         compiled from "/home/koehlert/public_html/themes/leo_wedding_dress/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19425438895d5960ec300496-55614197%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb5b87767b58069873d051b3019d8e19cdb58128' => 
    array (
      0 => '/home/koehlert/public_html/themes/leo_wedding_dress/contact-form.tpl',
      1 => 1497003683,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19425438895d5960ec300496-55614197',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5960ec41a9d6_32442059',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5960ec41a9d6_32442059')) {function content_5d5960ec41a9d6_32442059($_smarty_tpl) {?>
...
" method="post" class="contact-form-box" enctype="multipart/form-data">
		<fieldset>
			<h3 class="page-subheading size20"><?php echo smartyTranslate(array('s'=>'send a message'),$_smarty_tpl);?>
</h3>
			<div class="clearfix">
...
$_smarty_tpl->tpl_vars['flag']->value = true; $_smarty_tpl->tpl_vars['flag']->nocache = null; $_smarty_tpl->tpl_vars['flag']->scope = 0;
} else $_smarty_tpl->tpl_vars['flag'] = new Smarty_variable(true, null, 0);?>
...
" />
									<?php if (isset($_smarty_tpl->tpl_vars['flag'])) {$_smarty_tpl->tpl_vars['flag'] = clone $_smarty_tpl->tpl_vars['flag'];
$_smarty_tpl->tpl_vars['flag']->value = false; $_smarty_tpl->tpl_vars['flag']->nocache = null; $_smarty_tpl->tpl_vars['flag']->scope = 0;
} else $_smarty_tpl->tpl_vars['flag'] = new Smarty_variable(false, null, 0);?>
								<?php }?>
							<?php } ?>
...
"<?php if ($_smarty_tpl->tpl_vars['contact']->value['id_contact']==2) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
							<?php } ?>
						</select>
					</div>
...
<?php }?></textarea>
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars["modulesDir"])) {$_smarty_tpl->tpl_vars["modulesDir"] = clone $_smarty_tpl->tpl_vars["modulesDir"];
$_smarty_tpl->tpl_vars["modulesDir"]->value = @constant('_PS_MODULE_DIR_'); $_smarty_tpl->tpl_vars["modulesDir"]->nocache = null; $_smarty_tpl->tpl_vars["modulesDir"]->scope = 0;
} else $_smarty_tpl->tpl_vars["modulesDir"] = new Smarty_variable(@constant('_PS_MODULE_DIR_'), null, 0);?>
                        <?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['modulesDir']->value)."./captchadd/views/templates/hook/captchadd.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

			<div class="submit">
				<button type="submit" style="margin-left:15px;" name="submitMessage" id="submitMessage" class="button btn btn-outline button-medium"><span><?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
</span></button>
			</div>
		</fieldset>
	</form>
