			...
			<tr class="customized customized-{$product['id_order_detail']|intval}">
				...
				<td class="productQuantity text-center">
					...
					<span class="product_quantity_edit" style="display:none;">
						<input type="text" name="product_quantity[{$customizationId|intval}]" class="edit_product_quantity" value="{$customization['quantity']|htmlentities}" size="2"  autocomplete="off" />
					</span>
					{/if}
				</td>
				{if $display_warehouse}<td>&nbsp;</td>{/if}
