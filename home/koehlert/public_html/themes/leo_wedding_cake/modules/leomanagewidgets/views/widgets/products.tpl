...
<div class="carousel slide carousel-fade" id="{$tabname}">
	...
	<div class="carousel-inner">
	    ...
	    <p class="text-center">
	    	<a class="btn-new" href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='New products' mod='blocknewproducts'}">{l s='View all our items' mod='leomanagewidgets'}<i class="fa fa-long-arrow-right"></i></a>
	    </p>
</div>
