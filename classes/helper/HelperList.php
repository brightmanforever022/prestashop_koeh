            ...
            switch ($params['type']) {
                ...
                case 'select':
                    foreach ($params['list'] as $option_value => $option_display) {
                        ...
                        if(isset($params['filter_type']) && ($params['filter_type'] == 'multiint')){
                            $value = Tools::unSerialize(Context::getContext()->cookie->{$prefix.$this->list_id.'Filter_'.$params['filter_key']});
                        }
                    }
                    break;
